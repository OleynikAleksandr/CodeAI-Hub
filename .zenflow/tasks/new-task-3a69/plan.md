...
### [x] Step: Дефолтный Ризонинг
<!-- chat-id: 1e7d995e-6603-4b22-8dfd-07a4cf7d4e64 -->

Дефолтный Ризонинг почему то зашит намертво - я меняю медиум на хай, сохраняю изменения, а они не применяются - разберись и исправь
