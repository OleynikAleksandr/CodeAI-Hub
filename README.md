...
**Current Release — v1.2.198**

This release repairs the Project Manager Start card selector crash: provider,
model, and reasoning controls now use the in-app DOM listbox instead of native
CEF dropdowns.
