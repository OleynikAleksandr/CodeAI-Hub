...
- **Release line is archived and clean.** `1.2.20` carries forward the shipped duplication / PM refresh fix-set from `1.2.19`, keeps the planning closeout archived under `doc/SolidWorks-WorkFlow/Plans/Archive/`, and aligns active operational docs with the finalized release/docs flow.
