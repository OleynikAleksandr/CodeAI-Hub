...
- **Codex Reasoning Config**: Codex SDK обновляет `model_reasoning_effort` в `~/.codeai-hub/codex/config.toml`, синхронизируя CLI и SDK.
- **Provider Auto-Update**: On core startup, checks and optionally обновляет глобальные CLI/SDK для Claude, Codex и Gemini.

- **Artifact bundle**
- VSIX: `codeai-hub-1.1.327.vsix`
- Launcher: `CodeAIHubLauncher-macos-arm64-1.1.327.tar.bz2`
- Core: `codeai-hub-core-darwin-arm64-1.1.327.tar.bz2`
- Providers: `claude-module-1.1.327.tar.bz2`, `codex-module-1.1.327.tar.bz2`, `gemini-module-1.1.327.tar.bz2`
- UI: `vscode-webview-1.1.327.tar.bz2`, `web-client-1.1.327.tar.bz2`, `project-manager-1.1.327.tar.bz2`
