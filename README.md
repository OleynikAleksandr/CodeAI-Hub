...
**Current Release — v1.2.288** (Diagram Modules sidecar completion)
...
sidecar cleanup. It also fixes the final Diagram Modules completion boundary for
generated sidecars inside `.codeai-hub`.
