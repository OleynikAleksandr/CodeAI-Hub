...
- **Release closeout is archived and clean.** The duplication / PM refresh planning scope is archived under `doc/SolidWorks-WorkFlow/Plans/Archive/`, active operational docs now point to the finalized `1.2.19` release/docs flow, and the official release line remains `1.2.19`.
