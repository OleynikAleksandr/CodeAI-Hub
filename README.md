...
- **Flow-first UI start**: New sessions start by selecting a step (Simple Chat / Idea / Spec / Plan / Execute) before choosing a provider.
- **Release 1.1.390**: Built via `./scripts/build-all.sh` + `./scripts/build-release.sh --use-current-version`.
