...
## Current Release — v1.1.661
- Session UI: ■ now reliably stops Core via the shutdown endpoint (`POST /api/v1/shutdown`) and clears the confusing “Agent is working…” placeholder; next ▶ / Enter starts Core and sends after reconnect.
