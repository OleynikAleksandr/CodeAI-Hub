...
1. [DONE] `./scripts/build-all.sh --version 1.2.51` на чистом дереве.
2. [DONE] Git Commit: `chore: release 1.2.51` (hash: 05e666801)
3. [DONE] `./scripts/build-release.sh --use-current-version` — VSIX `codeai-hub-1.2.51.vsix` (2.3M) создан, SDK exclusions verified, VSIX runtime surface verified.
