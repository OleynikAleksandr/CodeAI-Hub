...
- **Planning source:** `doc/SolidWorks-WorkFlow/Plans/Archive/Runtime_Stability_Remediation_Architecture.md`
- **Read this context before implementation:**
  - `doc/SolidWorks-WorkFlow/System/SystemArchitecture.md`
  - `doc/SolidWorks-WorkFlow/Plans/Archive/Runtime_Stability_Remediation_Architecture.md`
...
1. [DONE] Получить явное approval от пользователя на planning-документ перед кодом; scope: `doc/SolidWorks-WorkFlow/Plans/Archive/Runtime_Stability_Remediation_Architecture.md`, `doc/TODO/todo-plan.md`; expected commit message: `docs: plan runtime stability remediation`
...
8. [DONE] Git Commit: `test: cover session translation settings cache` (hash: `bb8ca01b9`)
...
6. [DONE] Git Commit: `fix: log core bridge parsing and history failures` (hash: `05c0d6cd8`)
7. [DONE] Заменить silent best-effort catches в supervisor/status reconnect paths без изменения UX; scope: `src/client/ui/src/core-bridge/supervisor-requests.ts`, `src/client/ui/src/core-bridge/core-bridge.ts`, `doc/SolidWorks-WorkFlow/Modules/UI_Bundles.md`; expected commit message: `fix: log core bridge supervisor failures`
8. [DONE] Git Commit: `fix: log core bridge supervisor failures` (hash: `2acff1091`)
...
8. [DONE] Git Commit: `chore: package release 1.2.103` (hash: `d7e3dbdb1`)
