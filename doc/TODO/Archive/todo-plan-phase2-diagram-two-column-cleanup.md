...
**Execution Scope Status:** COMPLETED (archived 2026-04-21, release 1.2.37)
...
7. [DONE] Update `README.md` and `CHANGELOG.md` with target version 1.2.37 — scope: `README.md`, `CHANGELOG.md`.
8. [DONE] Git Commit: `docs: prepare diagram two-column cleanup release notes (1.2.37)` (hash: 943ac3542)

### Stream E: Build
9. [DONE] Run `./scripts/build-all.sh` (version bumps + tarballs in `doc/tmp/releases/`).
10. [DONE] Git Commit: `build: release 1.2.37` (hash: 023bcb616)
11. [DONE] Run `./scripts/build-release.sh --use-current-version` — produced `codeai-hub-1.2.37.vsix` (~2.37 MB).

### Stream F: Cycle closeout
12. [DONE] Archive planning-doc + todo-plan, update `doc/SolidWorks-WorkFlow/Docs_Index.md`.
13. [DONE] Git Commit: `docs: archive diagram two-column cleanup cycle (1.2.37)` (hash: landed in this commit)
14. [DONE] Session074 report created.
