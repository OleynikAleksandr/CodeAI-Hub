...
- **Planning source:** `doc/SolidWorks-WorkFlow/Plans/Archive/PM_TranslationEngineSelector_CEF_Crash_Architecture.md`
- **Read this context before implementation:**
  - `doc/SolidWorks-WorkFlow/Plans/Archive/PM_TranslationEngineSelector_CEF_Crash_Architecture.md`
  - `doc/BugRegistry.md`
...
2. [DONE] Git Commit: `chore: release 1.2.55` (hash: `d237ddf65`)
3. [DONE] Выполнить `./scripts/build-release.sh --use-current-version`, проверить `Step 7: Verifying SDK exclusions`, pruning dev dependencies и итоговый VSIX `codeai-hub-1.2.55.vsix`.
