...
- **Planning source:** `doc/SolidWorks-WorkFlow/Plans/Archive/WorkflowClear_WorkspaceOwnedGitRollback_Architecture.md`
...
- **Read this context before implementation:**
  ...
  - `doc/SolidWorks-WorkFlow/Plans/Archive/WorkflowClear_WorkspaceOwnedGitRollback_Architecture.md`
...
81. [DONE] `phase31.stream1.task1` Create a replacement planning document for full Git-only workflow rollback, including the workspace-owned runtime capsule, external state inventory, non-goals for manual projection/restore, and implementation phases that remove the hybrid runtime-slice rollback system (scope: `doc/SolidWorks-WorkFlow/Plans/Archive/WorkflowClear_WorkspaceOwnedGitRollback_Architecture.md, doc/TODO/todo-plan.md`; expected commit: `docs: plan workspace owned git rollback capsule`).
...
316. [DONE] Git Commit: `fix: untrack settings from workflow commits` (hash: 6b116ae80)

### Stream: Accepted-Step Regression Coverage
317. [DONE] `phase92.stream3.task1` Add focused accepted-step coverage proving a legacy tracked settings file is untracked, preserved on disk, and absent from workflow snapshot commits (scope: `packages/core/src/workflow/boundary/workflow-step-commit-facade.ts, packages/core/src/workflow/boundary/workflow-step-commit-facade.test.ts`; expected commit: `test: cover rollback ignored settings commits`).
318. [DONE] Git Commit: `test: cover rollback ignored settings commits` (hash: c5cbf7d74)
...
392. [DONE] Git Commit: `docs: prepare provider session cleanup release` (hash: 2bccaf7ff)
...
409. [DONE] Git Commit: `fix: hold managed turns until core settles` (hash: 64f8f07a7)
...
430. [DONE] Git Commit: `docs: sync workflow clear release architecture` (hash: 9c8c8e793)
