...
9. [DONE] Выполнить release pipeline `./scripts/build-all.sh` и `./scripts/build-release.sh --use-current-version`, зафиксировать version bumps / manifests / release artifacts; scope: release-generated files and manifests; expected commit message: `chore: release 1.2.61`
10. [DONE] Git Commit: `chore: release 1.2.61` (hash: `68136b575`)

### Stream: Scope closeout
11. [DONE] Архивировать planning doc в `doc/SolidWorks-WorkFlow/Plans/Archive/Settings_CanonicalPath_Fix_1.2.61.md`, архивировать active todo-plan в `doc/TODO/Archive/todo-plan-phase1-settings-canonical-path-fix-release-1.2.61.md`, создать новый neutral stub `doc/TODO/todo-plan.md`; scope: archived planning doc, archived todo-plan, neutral stub; expected commit message: `docs: archive settings canonical path release scope`
12. [DONE] Git Commit: `docs: archive settings canonical path release scope` (hash: TBD)
