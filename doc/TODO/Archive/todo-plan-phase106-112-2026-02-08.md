...
2. `doc/Sessions/Archive/Session118.md`
...
5. [DONE] Подготовить отчёт сессии после закрытия Phase 107 (scope: `doc/Sessions/Archive/Session115.md`, `doc/TODO/todo-plan.md`; expected commit: `docs(session): record phase 107 completion`)
