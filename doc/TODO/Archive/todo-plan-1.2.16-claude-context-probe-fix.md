...
3. [DONE] Архивировать `todo-plan.md`, вернуть placeholder `Execution Scope Status: EMPTY`. — scope: `doc/TODO/todo-plan.md`, `doc/TODO/Archive/todo-plan-1.2.16-claude-context-probe-fix.md`; commit: `docs: close 1.2.16 todo-plan after build`
4. [DONE] Git Commit: `docs: close 1.2.16 todo-plan after build` (hash: TBD → set in same commit)
