...
3. [IN_PROGRESS] Todo: archive plan + session report update (scope: `doc/TODO/Archive/*`, `doc/Sessions/Session040.md`; expected commit message: `docs(session): add session040 phase154 codex diagnostics`)
