...
2. [DONE] Git Commit: `docs: archive Claude list-marker formatting planning doc` (hash: `70d3286b1`)

### Stream: TODO Plan Closeout
1. [DONE] Заархивировать завершённый active todo-plan и восстановить placeholder `doc/TODO/todo-plan.md`. scope: `doc/TODO/todo-plan.md`, `doc/TODO/Archive/todo-plan-1.2.26-claude-session-list-marker-formatting-release.md`; expected commit: `docs: close 1.2.26 todo-plan after build`
