...
- **Planning source:** `doc/SolidWorks-WorkFlow/Plans/Archive/ManagedWorkflow_CleanStageMarkers_Planning.md`
...
3. [DONE] `managed-clean-markers.phase0.plan.task2` Create the planning source and register the active scope in the documentation index (scope: `doc/SolidWorks-WorkFlow/Plans/Archive/ManagedWorkflow_CleanStageMarkers_Planning.md, doc/SolidWorks-WorkFlow/Docs_Index.md, doc/TODO/todo-plan.md`; expected commit: `docs: plan clean stage markers`).
...
85. [DONE] Git Commit: `docs: record 1.2.290 release package` (hash: 243c7a23f)
