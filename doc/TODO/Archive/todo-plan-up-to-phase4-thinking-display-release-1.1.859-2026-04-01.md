...
1. [DONE] Create the approved planning doc and replace the placeholder TODO plan with this execution plan. Scope: `doc/SolidWorks-WorkFlow/Plans/Archive/Claude_Gemini_Thinking_Display_Architecture.md`, `doc/TODO/todo-plan.md`. Target commit: `docs(plan): define claude gemini thinking display scope`
