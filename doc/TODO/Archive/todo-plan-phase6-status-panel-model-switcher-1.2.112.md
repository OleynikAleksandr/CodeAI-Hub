...
- **Planning source:** `doc/SolidWorks-WorkFlow/Plans/Archive/StatusPanel_ModelReasoningSwitch_Architecture.md`
...
1. [DONE] Create approved planning-doc and active execution plan (scope: `doc/SolidWorks-WorkFlow/Plans/Archive/StatusPanel_ModelReasoningSwitch_Architecture.md`, `doc/TODO/todo-plan.md`, `doc/Sessions/Session035.md`; commit: `docs: plan status panel model switcher`)
...
41. [DONE] Archive completed todo-plan and planning-doc, update Docs Index, and create no-active-scope shell (scope: `doc/TODO/Archive/todo-plan-phase6-status-panel-model-switcher-1.2.112.md`, `doc/TODO/todo-plan.md`, `doc/SolidWorks-WorkFlow/Plans/Archive/StatusPanel_ModelReasoningSwitch_Architecture.md`, `doc/SolidWorks-WorkFlow/Docs_Index.md`; commit: `docs: archive status panel model switcher`; verified: release `1.2.112` packaged and active scope closed)
42. [IN_PROGRESS] Git Commit: `docs: archive status panel model switcher` (hash: TBD)
