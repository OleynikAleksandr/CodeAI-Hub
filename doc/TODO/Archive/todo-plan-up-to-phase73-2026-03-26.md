...
- Перед началом каждого stream открыть: `AGENTS.md`, `doc/Sessions/Archive/Session158.md`, `doc/SolidWorks-WorkFlow/System/SystemArchitecture.md`, `doc/SolidWorks-WorkFlow/Contracts/ProviderFailure_Recovery_And_ProviderSwitch.md`, `doc/SolidWorks-WorkFlow/Plans/Archive/MultiProvider_Orchestration_Scenarios.md`
