...
**Scope:** Provider Native Request Capture Workbench — Phase 1 PM-side diagnostic bypass
**Planning source:** `doc/SolidWorks-WorkFlow/Plans/Provider_Native_Request_Capture_Workbench_Architecture.md`
**Release:** `1.2.123`
**User acceptance:** 2026-05-01 — пользователь установил/протестировал release и подтвердил: "все работает".
