...
2. [IN_PROGRESS] Git Commit: `test: add codex base instructions capture flag` (hash: TBD)
3. [TODO] Prepare release notes for future version `1.2.74` — scope: `README.md`, `CHANGELOG.md`, `doc/TODO/todo-plan.md`; commit message: `docs: prepare codex base instructions test release notes`
4. [TODO] Git Commit: `docs: prepare codex base instructions test release notes` (hash: TBD)
5. [TODO] Build a new release package for compact base instructions retest and record VSIX/tarball paths — scope: release-generated version files, `doc/TODO/todo-plan.md`; release target: `1.2.74`; verification: `./scripts/build-all.sh`, `./scripts/build-release.sh --use-current-version`; commit message: `chore: build codex base instructions test release`
6. [TODO] Git Commit: `chore: build codex base instructions test release` (hash: TBD)
7. [TODO] Analyze user-provided `1.2.74` native capture logs and classify result — scope: `doc/SolidWorks-WorkFlow/Plans/Codex_Instruction_Stack_StepByStep_Flag_Tests.md`, `doc/TODO/todo-plan.md`; commit message: `docs: record codex base instructions evidence`
8. [TODO] Git Commit: `docs: record codex base instructions evidence` (hash: TBD)
