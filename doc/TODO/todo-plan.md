...
```json
{
  ...
  "expectedCommitMessage": "docs: prepare 1.2.430 release notes",
  "debt": {
    "expectedCommitMessage": "docs: prepare 1.2.430 release notes",
    "preCommitHead": "5ea744cfd",
...
14. [PENDING] Git Commit: `docs: prepare 1.2.430 release notes` (hash: TBD)
