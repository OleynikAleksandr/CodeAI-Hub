...
- Саб-агенту (исполнителю в отдельном терминале) выдаётся **только его фрагмент плана** (его задачи + критерии + scope).
- Саб-агенту запрещено выполнять задачи других волн/стримов, даже если он видит их в файле.
