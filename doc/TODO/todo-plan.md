...
13. [IN_PROGRESS] Прогнать таргетный launcher build и выполнить `./scripts/build-all.sh` с фиксацией release/version updates для версии `1.2.46` (scope: `packages/cef-launcher`, release/version manifests, `doc/TODO/todo-plan.md`; expected commit: `chore: release 1.2.46`)
