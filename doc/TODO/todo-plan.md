...
### Stream: Packaging
1. [TODO] Обновить release-facing docs под `1.2.31` для corrected thinking provider header accent и strengthened thinking bubble chrome; scope: `README.md`, `CHANGELOG.md`, `doc/TODO/todo-plan.md`; commit: `docs: prepare 1.2.31 release notes`
