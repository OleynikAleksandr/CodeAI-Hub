...
- _Note (2025-11-09): Release 1.1.168 собран (hotfix для CoreKeepAlive). Sticky keepalive/auto-restart задачи переведены в DONE, переходим к диагностике портов и UI._
