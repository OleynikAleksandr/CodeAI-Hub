...
6. [IN_PROGRESS] Git Commit: `feat: apply claude prompt profile to diagnostics` (hash: TBD)
7. [TODO] Apply the same Claude workflow system prompt to normal SDK query options while preserving `settingSources: []` — scope: `packages/Claude_Module/src/sdk/claude-sdk-manager.ts`, `packages/Claude_Module/src/sdk/claude-sdk-manager.test.ts`, `doc/TODO/todo-plan.md`; commit message: `feat: apply claude prompt profile to runtime`
8. [TODO] Git Commit: `feat: apply claude prompt profile to runtime` (hash: TBD)
9. [TODO] Update SSOT docs, release notes, and targeted verification for the final instruction-profile retest release — scope: `doc/SolidWorks-WorkFlow/Modules/Codex.md`, `doc/SolidWorks-WorkFlow/Modules/Claude.md`, `README.md`, `CHANGELOG.md`, `doc/TODO/todo-plan.md`; commit message: `docs: prepare instruction profile retest release`
10. [TODO] Git Commit: `docs: prepare instruction profile retest release` (hash: TBD)
11. [TODO] Build the new release package and stop for user retest — scope: generated version/release artifacts, `doc/TODO/todo-plan.md`, `doc/Sessions/Session004.md`; release target: TBD; verification: `./scripts/build-all.sh`, `./scripts/build-release.sh --use-current-version`; commit message: `chore: build instruction profile retest release`
12. [TODO] Git Commit: `chore: build instruction profile retest release` (hash: TBD)
