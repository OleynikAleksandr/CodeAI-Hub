...
```json
{
  ...
  "branch": "main",
  "baseHead": "da6d1ba50",
  "lastRecordedCommit": "da6d1ba50",
  "planningSource": "doc/SolidWorks-WorkFlow/Plans/ApplicationSkeleton_ProjectFoundation_Planning_RU.md",
  "currentTaskId": "app-skeleton-foundation.phase0.plan.task1",
  "expectedCommitMessage": "docs: open application skeleton foundation implementation",
  "debt": {
    "expectedCommitMessage": "docs: open application skeleton foundation implementation",
    "preCommitHead": "da6d1ba50",
    "stage": "commit_pending",
    "taskId": "app-skeleton-foundation.phase0.plan.task1"
  }
}
```
...
2. [PENDING] Git Commit: `docs: open application skeleton foundation implementation` (hash: TBD)
...
3. [TODO] `app-skeleton-foundation.phase1.prompt.task1` Update the Application Skeleton agent prompt, contract reference, and bundled-template regression test so the first prompt requires an installable project foundation, explicit unresolved-question handling, no materialization under ambiguity, and no Quality Gates tool ownership (scope: `packages/agents/application-skeleton-agent/assets/application-skeleton-prompt.md, packages/agents/application-skeleton-agent/assets/application-skeleton-contract.md, packages/core/src/templates/application-skeleton-bundled-templates.test.ts`; expected commit: `feat: require installable application skeleton foundation prompt`).
4. [TODO] Git Commit: `feat: require installable application skeleton foundation prompt` (hash: TBD)
