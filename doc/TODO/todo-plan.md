...
- **Planning source:** `doc/SolidWorks-WorkFlow/Plans/README_CurrentInstallationPath_Architecture.md`
...
2. [TODO] Git Commit: `docs: add current installation path to readme` (hash: TBD)
