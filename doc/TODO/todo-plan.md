...
- _Note (2025-11-09): Release 1.1.166 (Gemini CLI 0.11.x) собран. Взяты в работу sticky keepalive/auto-restart задачи из critical-плана, чтобы webview/launcher не гасили core при сворачивании._
