...
- _Note (2025-11-08): Release 1.1.173 adds the ensure/attach separation so VS Code and the launcher only reinstall when the manifest version does not match the running orchestrator._
