...
19. [TODO] Fix(non-regression): при необходимости внести минимальные корректировки для сохранения reopen/resume совместимости при включённой scoped delivery логике (scope: `src/client/project-manager/components/sessions/reviewer-session-visibility.ts`, `packages/core/src/remote-bridge/handlers/workspace-activate-service.ts`; expected commit message: `fix(non-regression): keep restart resume compatibility with scoped workspace isolation`)
20. [TODO] Git Commit: `fix(non-regression): keep restart resume compatibility with scoped workspace isolation` (hash: TBD)
