...
8. [IN_PROGRESS] Git Commit: `feat: hydrate application foundation envelope artifacts` (hash: TBD)
9. [TODO] Cover canonical envelope path resolution and cold-start artifact hydration in tests and workflow contract docs; scope: `packages/core/src/workflow/paths/workflow-artifact-paths.test.ts`, `packages/core/src/remote-bridge/handlers/workflow-state-service.test.ts`, `doc/SolidWorks-WorkFlow/Contracts/Workflow_CLI.md`; expected commit message: `test: cover application foundation envelope artifact hydration`
10. [TODO] Git Commit: `test: cover application foundation envelope artifact hydration` (hash: TBD)
