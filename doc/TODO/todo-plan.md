...
4. [IN_PROGRESS] Git Commit: `feat: apply codex prompt profile to runtime` (hash: TBD)
...
10. [TODO] Git Commit: `chore: build instruction profile retest release` (hash: TBD)
