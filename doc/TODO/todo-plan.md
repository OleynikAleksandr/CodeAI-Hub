...
3. [DONE] Build: `./scripts/build-all.sh` (version bump -> 1.1.594) (scope: repo build; expected commit message: `chore(release): build-all for next patch`)
4. [DONE] Git Commit: `chore(release): build-all for next patch` (hash: 98c48432)
