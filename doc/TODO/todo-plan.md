...
1. [TODO] Обновить `doc/BugRegistry.md`: BUG-2026-02-24-01 → Release `1.1.664` + указать commits; создать `doc/Sessions/Session018.md` (scope: `doc/BugRegistry.md`, `doc/Sessions/Session018.md`; expected commit: `chore(release): package vsix v1.1.664`).
