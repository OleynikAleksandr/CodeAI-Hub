...
6. [IN_PROGRESS] Git Commit: `feat: gate application foundation envelope after diagram modules` (hash: TBD)
7. [TODO] Add canonical artifact path and filesystem hydration support for `application-foundation-envelope.md`; scope: `packages/core/src/workflow/paths/workflow-paths-types.ts`, `packages/core/src/workflow/paths/workflow-artifact-paths.ts`, `packages/core/src/remote-bridge/handlers/workflow-state-filesystem-hydration.ts`; expected commit message: `feat: hydrate application foundation envelope artifacts`
8. [TODO] Git Commit: `feat: hydrate application foundation envelope artifacts` (hash: TBD)
