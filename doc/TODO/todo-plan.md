...
2. [TODO] Git Commit: `docs: prepare capture workbench clean handoff release` (hash: TBD)
...
4. [TODO] Git Commit: `chore: bump release manifests for capture workbench clean handoff` (hash: TBD)
...
6. [TODO] Git Commit: `docs: record capture workbench clean handoff release build` (hash: TBD)
