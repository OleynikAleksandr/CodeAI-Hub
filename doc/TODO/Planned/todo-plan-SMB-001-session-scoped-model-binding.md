...
**Plan ID:** `SMB-001`  
**Status:** `QUEUED` — не является активным `doc/TODO/todo-plan.md`  
**Planning source:** `doc/SolidWorks-WorkFlow/Plans/SessionScoped_ModelBinding_Architecture.md`  
**Created:** 2026-04-28  

> Activation note: перед выполнением этот файл нужно сделать активным execution plan, скопировав/переименовав его в `doc/TODO/todo-plan.md`. Одновременно активным может быть только один план.
