...
Node.js сервис (`@codeai-hub/core@1.1.545`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.545/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.545/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.545/
│       │   └── current -> 1.1.545
...
└── releases/
    ...
    ├── claude-module-1.1.545.tar.bz2
    ├── codex-module-1.1.545.tar.bz2
    ├── gemini-module-1.1.545.tar.bz2
    └── codeai-hub-core-darwin-arm64-1.1.545.tar.bz2
```
...
| Core | 1.1.545 |
| UI Bundles | 1.1.545 |
| Claude Module | 1.1.545 |
| Codex Module | 1.1.545 |
| Gemini Module | 1.1.545 |
