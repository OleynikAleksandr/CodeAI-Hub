...
Node.js сервис (`@codeai-hub/core@1.1.563`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.563/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.563/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.551/
│       │   └── current -> 1.1.563
...
└── releases/
    ├── CodeAIHubLauncher-macos-arm64-1.1.563.tar.bz2
    ├── vscode-webview-1.1.563.tar.bz2
    ├── project-manager-1.1.563.tar.bz2
    ├── claude-module-1.1.563.tar.bz2
    ├── codex-module-1.1.563.tar.bz2
    ├── gemini-module-1.1.563.tar.bz2
    └── codeai-hub-core-darwin-arm64-1.1.563.tar.bz2
```
...
| Core | 1.1.563 |
| UI Bundles | 1.1.563 |
| Claude Module | 1.1.563 |
| Codex Module | 1.1.563 |
| Gemini Module | 1.1.563 |
