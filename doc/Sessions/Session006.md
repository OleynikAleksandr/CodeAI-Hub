...
- Created the planning document `doc/SolidWorks-WorkFlow/Plans/ProjectManager_DialogFileLinks_OpenInVSCode_Architecture.md`.
- Created the active execution plan `doc/TODO/todo-plan.md` with implementation streams for dialog markdown interception, PM callback wiring, opener strategy, VS Code host handling, regression coverage, docs sync, and release packaging.
