...
- Создан новый planning-doc [PostRelease_Regression_Feedback_Architecture.md](../../doc/SolidWorks-WorkFlow/Plans/Archive/PostRelease_Regression_Feedback_Architecture.md), который переводит следующий scope в режим live regression intake вместо спекулятивных фиксов.
- Активный [todo-plan.md](../../doc/TODO/todo-plan.md) полностью заменён на `Phase 27 — Post-Release Regression Feedback Loop`.
