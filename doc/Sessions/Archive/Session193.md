...
- На основе двух документов собран единый execution-source документ [ProjectManager_CentralPanels_ExecutionPlanning_Source.md](../../SolidWorks-WorkFlow/Plans/Archive/ProjectManager_CentralPanels_ExecutionPlanning_Source.md), уже ориентированный на следующий `doc/TODO/todo-plan.md`.
