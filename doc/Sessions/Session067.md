...
- Все doc-правки этой сессии были затем зафиксированы отдельным commit closeout `04eee951 docs(architecture): sync provider turn-start ack contracts`; рабочее дерево больше не оставалось dirty после этого sync.

## Git commits
- `04eee951 docs(architecture): sync provider turn-start ack contracts`
