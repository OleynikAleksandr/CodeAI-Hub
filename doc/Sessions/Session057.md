...
- `4389950 docs(release): update 1.1.387 notes`
- `2c87928 chore(release): prepare 1.1.387`
...
- При необходимости проверить артефакты: `codeai-hub-1.1.387.vsix` и tarball'ы в `~/.codeai-hub/releases/`.
- При необходимости выполнить e2e проверку релиза 1.1.387.
