...
- Зафиксирован ожидаемый пользовательский сценарий до уровня `Plan`; `Execute` вынесен в отдельную будущую архитектуру (оркестрация по входному `plan.md`).
...
- `13ac8ca6 docs: align user flow and postpone execute`
