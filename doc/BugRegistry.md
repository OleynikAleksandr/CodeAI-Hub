...
|---:|:------:|------|------------------|----------|
| BUG-2026-04-27-02 | FIXED | Codex Runtime/UI | `gpt-5.3-codex-spark` runs after 1.2.96 but shows no reasoning bubbles because readable summaries fall back to model default `none` | 1.2.97 |
