...
**Release Focus:** v1.1.332 — полная пересборка VSIX, чтобы описания и артефакты совпадали с Codex reasoning override + focus-ring polish.
