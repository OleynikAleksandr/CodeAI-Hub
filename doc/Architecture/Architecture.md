...
- **Idea Collector artifacts (v1.1.378)**: schema читается из `~/.codeai-hub/templates/full-development-flow/idea/idea-collector-schema.json`, а артефакты пишутся в `.codeai-hub/initiatives/<initiativeSlug>/runs/<runSlug>/idea/` (`idea.md`, `virtual-simulation.md`).
