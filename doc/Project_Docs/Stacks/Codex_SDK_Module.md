...
## 1. Purpose & Scope
- Document the structure and behaviour of the Codex TypeScript SDK so we can implement and maintain provider module `@codeai-hub/codex-module@1.1.417` inside CodeAI-Hub Core.
