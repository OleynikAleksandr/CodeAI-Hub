...
Validated in release `1.1.420` (runtime installs + provider registry wiring are stable; exact CLI versions remain user-managed via global npm + optional auto-update).
