...
## Текущие версии
- VSIX: `codeai-hub` 1.1.390
- Автономное ядро: `@codeai-hub/core` 1.1.390
- UI Bundles: 1.1.390
- Claude module: 1.1.390
- Codex module: 1.1.390
- Gemini module: 1.1.390
- Agent Shared: `@codeai-hub/agent-shared` 1.1.390
- Idea Collector: `@codeai-hub/idea-collector` 1.1.390
- Spec Creator: `@codeai-hub/spec-creator` 1.1.390 (skeleton)
