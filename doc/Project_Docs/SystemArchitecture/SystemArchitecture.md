...
## Текущие версии
- VSIX: `codeai-hub` 1.1.395
- Автономное ядро: `@codeai-hub/core` 1.1.395
- UI Bundles: 1.1.395
- Claude module: 1.1.395
- Codex module: 1.1.395
- Gemini module: 1.1.395
- Agent Shared: `@codeai-hub/agent-shared` 1.1.395
- Idea Collector: `@codeai-hub/idea-collector` 1.1.395
- Spec Creator: `@codeai-hub/spec-creator` 1.1.395 (skeleton)
