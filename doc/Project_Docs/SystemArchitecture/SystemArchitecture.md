...
Node.js сервис (`@codeai-hub/core@1.1.498`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.498/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.498/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.498/
│       │   └── current -> 1.1.498
...
| Core | 1.1.498 |
| UI Bundles | 1.1.498 |
| Claude Module | 1.1.498 |
| Codex Module | 1.1.498 |
| Gemini Module | 1.1.498 |
