...
## Текущие версии
- VSIX: `codeai-hub` 1.1.389
- Автономное ядро: `@codeai-hub/core` 1.1.389
- UI Bundles: 1.1.389
- Claude module: 1.1.389
- Codex module: 1.1.389
- Gemini module: 1.1.389
- Agent Shared: `@codeai-hub/agent-shared` 1.1.389
- Idea Collector: `@codeai-hub/idea-collector` 1.1.389
- Spec Creator: `@codeai-hub/spec-creator` 1.1.389 (skeleton)
