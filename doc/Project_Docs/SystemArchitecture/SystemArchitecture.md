...
Node.js сервис (`@codeai-hub/core@1.1.475`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.475/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.475/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.475/
│       │   └── current -> 1.1.475
...
| Core | 1.1.475 |
| UI Bundles | 1.1.475 |
| Claude Module | 1.1.475 |
| Codex Module | 1.1.475 |
| Gemini Module | 1.1.475 |
