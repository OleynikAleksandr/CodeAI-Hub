...
Node.js сервис (`@codeai-hub/core@1.1.499`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.499/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.499/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.499/
│       │   └── current -> 1.1.499
...
| Core | 1.1.499 |
| UI Bundles | 1.1.499 |
| Claude Module | 1.1.499 |
| Codex Module | 1.1.499 |
| Gemini Module | 1.1.499 |
