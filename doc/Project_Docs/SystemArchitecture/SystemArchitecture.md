...
## Текущие версии
- VSIX: `codeai-hub` 1.1.393
- Автономное ядро: `@codeai-hub/core` 1.1.393
- UI Bundles: 1.1.393
- Claude module: 1.1.393
- Codex module: 1.1.393
- Gemini module: 1.1.393
- Agent Shared: `@codeai-hub/agent-shared` 1.1.393
- Idea Collector: `@codeai-hub/idea-collector` 1.1.393
- Spec Creator: `@codeai-hub/spec-creator` 1.1.393 (skeleton)
...
└── releases/
    ├── CodeAIHubLauncher-macos-arm64-1.1.387.tar.bz2
    ├── vscode-webview-1.1.387.tar.bz2
    ├── web-client-1.1.387.tar.bz2
    ├── project-manager-1.1.387.tar.bz2
    ├── claude-module-1.1.387.tar.bz2
    ├── codex-module-1.1.387.tar.bz2
    ├── gemini-module-1.1.387.tar.bz2
    └── codeai-hub-core-darwin-arm64-1.1.387.tar.bz2
```
