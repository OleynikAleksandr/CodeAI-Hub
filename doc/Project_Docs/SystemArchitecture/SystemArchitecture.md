...
Node.js сервис (`@codeai-hub/core@1.1.478`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.478/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.478/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.478/
│       │   └── current -> 1.1.478
...
└── releases/
    ├── CodeAIHubLauncher-macos-arm64-1.1.478.tar.bz2
    ├── vscode-webview-1.1.478.tar.bz2
    ├── project-manager-1.1.478.tar.bz2
    ├── claude-module-1.1.478.tar.bz2
    ├── codex-module-1.1.478.tar.bz2
    ├── gemini-module-1.1.478.tar.bz2
    └── codeai-hub-core-darwin-arm64-1.1.478.tar.bz2
```
...
| Core | 1.1.478 |
| UI Bundles | 1.1.478 |
| Claude Module | 1.1.478 |
| Codex Module | 1.1.478 |
| Gemini Module | 1.1.478 |
