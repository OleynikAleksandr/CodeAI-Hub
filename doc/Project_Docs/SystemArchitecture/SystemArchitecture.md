...
## Текущие версии
- VSIX: `codeai-hub` 1.1.394
- Автономное ядро: `@codeai-hub/core` 1.1.394
- UI Bundles: 1.1.394
- Claude module: 1.1.394
- Codex module: 1.1.394
- Gemini module: 1.1.394
- Agent Shared: `@codeai-hub/agent-shared` 1.1.394
- Idea Collector: `@codeai-hub/idea-collector` 1.1.394
- Spec Creator: `@codeai-hub/spec-creator` 1.1.394 (skeleton)
