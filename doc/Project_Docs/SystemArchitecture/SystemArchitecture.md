...
**Состояние:** релиз 1.1.273 (18.11.2025) — Autonomous Core с TTL/idle‑моделью, Core Supervisor как единая точка старта ядра, файловый реестр провайдеров и обновлённый UI с фиксированными панелями и отдельной прокруткой в диалоговом окне (Markdown-рендеринг, авто‑scroll и единые отступы).
