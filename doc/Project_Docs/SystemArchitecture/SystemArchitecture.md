...
Node.js сервис (`@codeai-hub/core@1.1.474`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.474/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.474/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.474/
│       │   └── current -> 1.1.474
...
| Core | 1.1.474 |
| UI Bundles | 1.1.474 |
| Claude Module | 1.1.474 |
| Codex Module | 1.1.474 |
| Gemini Module | 1.1.474 |
