...
Node.js сервис (`@codeai-hub/core@1.1.500`), упакованный как JS-бандл + официальный Node 20 runtime.
...
~/.codeai-hub/
├── core/
│   └── darwin-arm64/1.1.500/
│       ├── node/
│       ├── app/
│       └── install.json
├── packages/
│   ├── launcher/macos-arm64/1.1.500/
│   └── ui/
│       ├── vscode-webview/
│       │   ├── 1.1.500/
│       │   └── current -> 1.1.500
...
| Core | 1.1.500 |
| UI Bundles | 1.1.500 |
| Claude Module | 1.1.500 |
| Codex Module | 1.1.500 |
| Gemini Module | 1.1.500 |
