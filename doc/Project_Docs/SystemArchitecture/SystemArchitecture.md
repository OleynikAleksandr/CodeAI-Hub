...
## Текущие версии
- VSIX: `codeai-hub` 1.1.391
- Автономное ядро: `@codeai-hub/core` 1.1.391
- UI Bundles: 1.1.391
- Claude module: 1.1.391
- Codex module: 1.1.391
- Gemini module: 1.1.391
- Agent Shared: `@codeai-hub/agent-shared` 1.1.391
- Idea Collector: `@codeai-hub/idea-collector` 1.1.391
- Spec Creator: `@codeai-hub/spec-creator` 1.1.391 (skeleton)
