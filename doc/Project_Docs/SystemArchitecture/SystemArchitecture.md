...
**Состояние:** релиз 1.1.174 (09.11.2025) — Gemini CLI 0.11.x поддерживается из коробки, новые релизы больше не принудительно убивают core, и мы продолжаем работу над владением портами.
