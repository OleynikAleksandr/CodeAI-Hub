...
**Состояние:** релиз 1.1.418 (15.01.2026) — Project Manager: Workflow Tree workbench (контекстный сайдбар, tool palette, status bar, сплит сессии/артефактов).
