...
**Parent plan:** `Plans/Provider_Native_Request_Capture_Workbench_Architecture.md` (rev5). This document is the UI specification referenced by parent §3.3 and Phase 3.
...
- `doc/SolidWorks-WorkFlow/Plans/Provider_Native_Request_Capture_Workbench_Architecture.md` — parent plan; §2 Product Goal, §3.3 Detached UI, §3.4 Paired artifacts, §3.6 Translation contract, §4 Phase boundaries.
