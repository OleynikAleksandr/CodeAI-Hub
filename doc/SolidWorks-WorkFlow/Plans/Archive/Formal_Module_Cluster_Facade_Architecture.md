...
**Статус:** Archived discussion baseline
**Дата:** 2026-03-20
**Архивировано:** 2026-05-01
...
> Archive note (2026-05-01): этот документ больше не является активным SSOT в `Contracts/`.
> Он сохранён как historical/discussion baseline для formal module/cluster grammar.
> Текущие обязательные правила фасадов и границ живут в `Contracts/FacadeClassDiagram_DesignAndMaintenance.md`, глобальные runtime-инварианты — в `System/SystemArchitecture.md`, а будущий branch workflow — в `Plans/DevelopmentTree_BranchWorkflow_Architecture.md`.
