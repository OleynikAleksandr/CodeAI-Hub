...
Архитектура: `doc/SolidWorks-WorkFlow/Contracts/SessionContinuity.md`.
...
Референс реализации Phase 101: `doc/SolidWorks-WorkFlow/Contracts/WorkspaceRuntime.md`.
...
**Подробнее:** `doc/SolidWorks-WorkFlow/Contracts/Workflow_CLI.md`
...
- **Docs index:** `doc/SolidWorks-WorkFlow/Docs_Index.md`
- **Clusters:** `doc/SolidWorks-WorkFlow/Clusters/`
- **Modules:** `doc/SolidWorks-WorkFlow/Modules/`
- **Contracts:** `doc/SolidWorks-WorkFlow/Contracts/`
- **Archive (migration staging; not SSOT):** `doc/SolidWorks-WorkFlow/Archive/`
