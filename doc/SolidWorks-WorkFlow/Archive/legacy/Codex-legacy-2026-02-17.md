...
8. Thinking в UI в MVP берётся из native reasoning событий провайдера; RU thinking summary через отдельное поле structured output не используется.
...
## 14. Reference Links
- CodeAI Hub structured outputs + thinking UX: описано в этом документе (Thinking берём из native reasoning событий провайдера; structured output для RU summary не используем).
