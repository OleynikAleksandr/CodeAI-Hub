...
Ниже сохранён legacy‑контент “as-is” для форензики. Текущий SSOT по Claude: `doc/SolidWorks-WorkFlow/Modules/Claude.md`. Новые изменения фиксируем только в SSOT-документах (не в `Archive/legacy`).
