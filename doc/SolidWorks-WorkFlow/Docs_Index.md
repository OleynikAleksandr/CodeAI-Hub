...
- `Plans/Settings_Save_Notification_Overlay_Fix.md` — active UX scope for removing the stale settings-save overlay notification that covers the Settings footer.
