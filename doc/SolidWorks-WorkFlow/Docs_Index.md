...
- `Plans/ProjectManager_LeftSidebar_ActiveStageSync_Architecture.md` — active planning scope for making the left Project Manager tree follow the canonical `activeStage`, with one expanded branch, explicit selected-stage highlight, and regression coverage for cross-surface stage sync.
