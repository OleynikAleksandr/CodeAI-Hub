...
- `Plans/Archive/Foundation_Envelope_VisualProjection_Architecture.md` — completed visual wave for `Foundation Envelope`; shipped release `1.1.905` with React Flow `Artifacts`, runtime-owned `foundation-envelope.flow.json`, prompt/SSOT sync, verification, and release packaging.
