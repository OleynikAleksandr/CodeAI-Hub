...
- `Plans/SessionUsageLimitsRefresh_Architecture.md` — design intake для session-scoped refresh usage limits при workspace restore и переключении между workflow sessions/steps в Project Manager.
