...
- `Plans/ThinkingTranslationOverlay_Architecture.md` — planning scope для deferred translation overlay visible reasoning/thinking: Core-owned async translation, stable message identity, per-session translation sidecar, merged history load и live patch events без переписывания canonical transcript.
