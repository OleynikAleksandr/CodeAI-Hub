...
- Status Panel chips drive both Claude and Codex switches. Each provider exposes two independent transport commands; see release `1.2.120` decoupling notes above and the Claude module SSOT for symmetry.
