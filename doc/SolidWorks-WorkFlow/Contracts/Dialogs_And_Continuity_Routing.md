...
- Для trunk flow-node continuity один и тот же create-report/resume lifecycle применяется к `description`, `virtual_simulation` и `diagram_modules`; branch/run agents не участвуют в этом routing contract.
