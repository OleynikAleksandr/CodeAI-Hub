...
Целевая release line этого контракта: `v1.1.716`. Начиная с неё diagnostics trail считается обязательным end-to-end для workflow submit path в PM/Core/Codex.
