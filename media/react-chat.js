(() => {
		...
		"node_modules/react/cjs/react.production.min.js"(exports) {
			...
			function M(a, b, e) {
				...
				if (null != b)
					...
					b))
						J.call(b, d) && !Object.hasOwn(L, d) && (c[d] = b[d]);
			...
			exports.forwardRef = (a) => ({ $$typeof: v, render: a });
			...
			exports.useCallback = (a, b) => U.current.useCallback(a, b);
			exports.useContext = (a) => U.current.useContext(a);
			exports.useDebugValue = () => {};
			exports.useDeferredValue = (a) => U.current.useDeferredValue(a);
			exports.useEffect = (a, b) => U.current.useEffect(a, b);
			exports.useId = () => U.current.useId();
			exports.useImperativeHandle = (a, b, e) =>
				U.current.useImperativeHandle(a, b, e);
			exports.useInsertionEffect = (a, b) => U.current.useInsertionEffect(a, b);
			exports.useLayoutEffect = (a, b) => U.current.useLayoutEffect(a, b);
			exports.useMemo = (a, b) => U.current.useMemo(a, b);
			exports.useReducer = (a, b, e) => U.current.useReducer(a, b, e);
			exports.useRef = (a) => U.current.useRef(a);
			exports.useState = (a) => U.current.useState(a);
			exports.useSyncExternalStore = (a, b, e) =>
				U.current.useSyncExternalStore(a, b, e);
			exports.useTransition = () => U.current.useTransition();
	...
	var require_scheduler_production_min = __commonJS({
		"node_modules/scheduler/cjs/scheduler.production.min.js"(exports) {
			...
			if (
				...
				l = performance;
				exports.unstable_now = () => l.now();
			} else {
				(p = Date), (q = p.now());
				exports.unstable_now = () => p.now() - q;
			}
			var l;
			var p;
			var q;
			...
			exports.unstable_cancelCallback = (a) => {
				a.callback = null;
			};
			exports.unstable_continueExecution = () => {
				A || z || ((A = true), I(J));
			};
			exports.unstable_forceFrameRate = (a) => {
				0 > a || 125 < a
					? console.error(
			...
			exports.unstable_getCurrentPriorityLevel = () => y;
			exports.unstable_getFirstCallbackNode = () => h(r);
			exports.unstable_next = (a) => {
				switch (y) {
					case 1:
					case 2:
					case 3: {
			...
			exports.unstable_runWithPriority = (a, b) => {
				switch (a) {
					case 1:
					case 2:
					case 3:
			...
			exports.unstable_scheduleCallback = (a, b, c) => {
			...
			exports.unstable_wrapCallback = (a) => {
				var b = y;
				return function () {
					var c = y;
					y = b;
	...
	var require_react_dom_production_min = __commonJS({
		"node_modules/react-dom/cjs/react-dom.production.min.js"(exports) {
			...
			function ta(a, b, c, d) {
				var e = Object.hasOwn(z, b) ? z[b] : null;
				if (
					null !== e
						? 0 !== e.type
						: d ||
			...
			function rd(a) {
				function b(b2, d, e, f, g) {
					...
					for (var c in a)
						Object.hasOwn(a, c) && ((b2 = a[c]), (this[c] = b2 ? b2(f) : f[c]));
			...
			var Ad = A({}, ud, {
				...
				movementY: (a) => ("movementY" in a ? a.movementY : xd),
			});
			var Bd = rd(Ad);
			...
			var Qd = A({}, ud, {
				...
				locale: 0,
				getModifierState: zd,
				charCode: (a) => ("keypress" === a.type ? od(a) : 0),
				keyCode: (a) =>
			...
			function Ze(a) {
				...
				var b = We[a],
					c;
				for (c in b) if (Object.hasOwn(b, c) && c in Ye) return (Xe[a] = b[c]);
				return a;
			}
			...
			var Jf =
				"function" === typeof queueMicrotask
					? queueMicrotask
					: "undefined" !== typeof Hf
						? (a) => Hf.resolve(null).then(a).catch(If)
						: Ff;
			function If(a) {
				setTimeout(() => {
					throw a;
			...
			function ui(a, b, c) {
				...
				He(c, b) ||
					((c = yc()), (M.lanes |= c), (rh |= c), (a.baseState = true));
				return b;
			}
			function vi(a, b) {
				var c = C;
			...
			var Oh = {
				...
				useLayoutEffect: (a, b) => ki(4194308, 4, a, b),
				useInsertionEffect: (a, b) => ki(4, 2, a, b),
				useMemo: (a, b) => {
					var c = Th();
					b = void 0 === b ? null : b;
					a = a();
				...
				useState: hi,
				useDebugValue: ri,
				useDeferredValue: (a) => (Th().memoizedState = a),
				useTransition: () => {
					var a = hi(false),
						b = a[0];
					a = vi.bind(null, a[1]);
			...
			var Ei = {
				isMounted: (a) => ((a = a._reactInternals) ? Vb(a) === a : false),
			...
			Bj = (a, b, c, d) => {
				...
				if (e !== d) {
					...
					c = null;
					for (l in e)
						if (!Object.hasOwn(d, l) && Object.hasOwn(e, l) && null != e[l])
							if ("style" === l) {
								var h = e[l];
								for (g in h)
									Object.hasOwn(h, g) && (c || (c = {}), (c[g] = ""));
							} else
			...
			ml.prototype.unstable_scheduleHydration = (a) => {
				if (a) {
					var b = Hc();
			...
			exports.flushSync = (a) => Rk(a);
			exports.hydrate = (a, b, c) => {
				if (!ol(b)) throw Error(p(200));
				return rl(null, a, b, true, c);
			};
			exports.hydrateRoot = (a, b, c) => {
			...
			exports.render = (a, b, c) => {
				if (!ol(b)) throw Error(p(200));
				return rl(null, a, b, false, c);
			};
			exports.unmountComponentAtNode = (a) => {
				if (!ol(a)) throw Error(p(40));
				return a._reactRootContainer
					? (Rk(() => {
							rl(null, null, a, false, () => {
			...
			exports.unstable_renderSubtreeIntoContainer = (a, b, c, d) => {
	...
	var require_react_jsx_runtime_production_min = __commonJS({
		"node_modules/react/cjs/react-jsx-runtime.production.min.js"(exports) {
			...
			function q(c, a, g) {
				...
				for (b in a) m.call(a, b) && !Object.hasOwn(p, b) && (d[b] = a[b]);
				if (c && c.defaultProps)
	...
	var require_utilities = __commonJS({
		"node_modules/style-to-js/cjs/utilities.js"(exports) {
			...
			var skipCamelCase = (property) =>
				!property ||
				NO_HYPHEN_REGEX.test(property) ||
				CUSTOM_PROPERTY_REGEX.test(property);
			var capitalize = (match, character) => character.toUpperCase();
			var trimHyphen = (match, prefix) => "".concat(prefix, "-");
	...
	var require_cjs3 = __commonJS({
		"node_modules/style-to-js/cjs/index.js"(exports, module) {
			...
			function StyleToJS(style, options) {
				...
				(0, style_to_object_1.default)(style, (property, value) => {
					if (property && value) {
	...
	var MESSAGE_ORDER = ["core", "claude", "codex", "gemini"];
	...
	var ProviderOption = ({ provider, checked, onToggle, inputRef }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "provider-picker__label",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "provider-picker__label-title",
							children: [
								provider.title,
								provider.description
									? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "provider-picker__label-description-inline",
						...
						warning
							? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "provider-picker__warning",
									children: warning,
								})
							: null,
					],
	...
	var ProviderPicker = ({ visible, providers, onConfirm, onCancel }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "Choose providers",
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "provider-picker__description",
					children:
						"Select exactly one provider for your new session. Install and authenticate each CLI before continuing.",
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					className: "provider-picker__form",
					onSubmit: handleSubmit,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", {
							className: "provider-picker__fieldset",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("legend", {
									className: "provider-picker__legend",
									children: "Connected provider stacks",
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									"aria-hidden": "true",
									className: "provider-picker__spacer",
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "provider-picker__options",
									children: providers.map((provider, index2) =>
										renderOption(provider, index2),
									),
								}),
							],
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "provider-picker__actions",
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "provider-picker__action-buttons",
									children: [
	...
	var getDefaultProviderTitle = (providerId) =>
	...
	var getDefaultProviderDescription = (providerId) =>
		PROVIDER_DESCRIPTION_MAP[providerId] ?? "";
	...
	var isProviderDescriptorCandidate = (value) => {
		...
		const hasValidStatusMessage =
			candidate.statusMessage === void 0 ||
	...
	var DEFAULT_PROVIDER_IDS = ["claudeCodeCli", "codexCli", "geminiCli"];
	...
	var sanitizeMessage = (message) => {
		...
		if (!["assistant", "user", "system", "thinking"].includes(role)) {
			return null;
		}
		return {
			id: message.id,
	...
	var convertStatusResponse = (status, fallbackProviders) => {
		const providers = status.providers
			...
			.filter((provider) => Boolean(provider)) ?? [...fallbackProviders];
		const sessions =
			status.sessions
	...
	var isDeletedPayload = (payload) =>
		typeof payload === "object" &&
		payload !== null &&
		typeof payload.sessionId === "string";
	var isStreamPayload = (payload) =>
		typeof payload === "object" &&
		payload !== null &&
		typeof payload.sessionId === "string";
	...
	var loadSessionHistories = async (config, sessions, notify) => {
		await Promise.all(
			sessions.map((session) =>
				fetchSessionHistory(config, session.id, notify),
			),
		);
	};
	...
	var useProviderPickerState = () => {
		const [pickerState, setPickerState] = (0, import_react2.useState)(
			defaultPickerState,
		);
		const [catalog, setCatalog] = (0, import_react2.useState)({});
		const providerLabels = (0, import_react2.useMemo)(
			() => buildProviderLabels(catalog),
			[catalog],
		);
		const resetPicker = (0, import_react2.useCallback)(() => {
			setPickerState(defaultPickerState);
		}, []);
		const openPicker = (0, import_react2.useCallback)((providers) => {
	...
	var useSessionStore = (providerLabels) => {
		...
		const [activeSessionId, setActiveSessionId] = (0, import_react3.useState)(
			null,
		);
		...
		const applyPendingBinding = (0, import_react3.useCallback)((session) => {
		...
		const handleSessionMessageEvent2 = (0, import_react3.useCallback)(
			(payload) => {
				setSnapshots((previous3) =>
					appendMessageToSnapshots(previous3, payload),
				);
			},
			[],
		);
		const handleSessionHistoryEvent = (0, import_react3.useCallback)(
			(payload) => {
				setSnapshots((previous3) =>
					mergeHistoryIntoSnapshots(previous3, payload),
				);
			},
			[],
		);
		...
		const toggleTodo = (0, import_react3.useCallback)((sessionId, todoId) => {
			setSnapshots((previous3) =>
				toggleTodoInSnapshots(previous3, sessionId, todoId),
			);
		}, []);
	...
	var useSettingsVisibility = () => {
		const [settingsVisible, setSettingsVisible] = (0, import_react4.useState)(
			false,
		);
	...
	var handleSessionHistoryMessage = (message, onSessionHistory) => {
		...
		const normalized = payload.messages
			.map((candidate) => sanitizeMessage(candidate))
	...
	var dispatchWebviewMessage = (rawMessage, handlers2) => {
		...
		switch (message.type) {
			case "core:connection": {
				if (handlers2.onCoreConnectionStatus && message.payload) {
					...
					if (typeof status === "string") {
						const detail =
							typeof candidate.detail === "string" ? candidate.detail : void 0;
			...
			case "providerPicker:open":
				handleProviderPickerOpenMessage(
					message,
					handlers2.onProviderPickerOpen,
				);
				return;
	...
	var ActionBar = ({ disabled = false }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("header", {
			className: "action-bar",
			children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", {
				className: "action-bar__surface",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", {
						...
						children: BUTTONS.map(({ id, label, highlighted }) =>
	...
	var SettingsCard = ({ title, action, children }) =>
	...
	var GeminiNotice = () =>
		/* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", {
			style: infoStyles,
			children: "Updates for Gemini are handled by application developers.",
		});
	var WarningBanner = ({ provider }) =>
		/* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", {
			style: { ...warningStyles, ...providerBannerStyles(provider) },
			children:
				"Warning: Updating is at your own risk. New versions may be incompatible. Updating will close active sessions.",
		});
	var ProviderVersions = ({ provider, versions, onUpdate }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
			settings_card_default,
			{
				action: snapshot?.checkedAt
					? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", {
							style: metadataTextStyles,
							children: [
								"Checked: ",
				...
				children: [
					provider !== "gemini"
						? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(WarningBanner, {
								provider,
							})
						: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(GeminiNotice, {}),
					versions.error
						? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", {
								style: errorStyles,
								children: versions.error,
							})
						: null,
					versions.loading && !hasProviderVersions
						? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", {
								style: statusStyles,
								children: "Loading version information\u2026",
							})
						: null,
					pendingTarget
						? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", {
								style: statusStyles,
								children:
									"Click the highlighted button again to confirm update. Active sessions will close.",
							})
						: null,
					/* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", {
						...
						children: rows.map((row) =>
							/* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
								VersionRowItem,
								{
									...
									pendingConfirmation: row.target
										? isPending(row.target)
										: false,
									row,
								},
								row.packageName,
...
`;
	...
	var ThinkingTokenInput = ({ value, onChange }) => {
	...
	var ThinkingSettings = ({ enabled, maxTokens, onChange }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime12.jsx)("style", {
					children: hideSpinnerStyle,
				}),
				/* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(settings_card_default, {
					title: "Claude Thinking Settings",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
							thinking_toggle_default,
							{ enabled, onToggle: handleToggle },
						),
						/* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
							thinking_token_input_default,
							{ onChange: handleTokenChange, value: maxTokens },
						),
						/* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
							thinking_pro_tip_default,
							{},
						),
					],
				}),
	...
	var useSettingsState = () => {
		const initialSettingsRef = (0, import_react11.useRef)(
		...
		const handleUpdateProvider = (0, import_react11.useCallback)(
			(provider, target) => {
				...
				setVersions((prev) => ({
					...prev,
					updatingTargets: [
						.../* @__PURE__ */ new Set([...prev.updatingTargets, targetKey]),
					],
				}));
				vscode_default.postMessage({
	...
	var SettingsView = ({ onClose }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", {
			style: containerStyles4,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime13.jsx)(settings_header_default, {
					onClose,
				}),
				/* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", {
					style: tabBarStyles,
					children: settingsTabs.map((tab2) =>
				...
				/* @__PURE__ */ (0, import_jsx_runtime13.jsx)(settings_footer_default, {
					hasChanges,
					onClose,
					onReset: handleReset,
					onSave: handleSave,
	...
	function create(definition3) {
		...
		for (const [property, value] of Object.entries(definition3.properties)) {
			...
			if (
				definition3.mustUseProperty &&
				definition3.mustUseProperty.includes(property)
			) {
	...
	function one(state, node2, key) {
		...
		if (
			node2.type === "mdxFlowExpression" ||
			node2.type === "mdxTextExpression"
		) {
			return mdxExpression(state, node2);
		}
		if (
			node2.type === "mdxJsxFlowElement" ||
	...
	function element(state, node2, key) {
		...
		if (tableElements.has(node2.tagName)) {
			children = children.filter((child) =>
				typeof child === "string" ? !whitespace(child) : true,
			);
		}
	...
	function mdxJsxElement(state, node2, key) {
		...
		const type =
			node2.name === null
				? state.Fragment
				: findComponentFromName(state, node2.name, true);
	...
	function productionCreate(_, jsx26, jsxs24) {
		return create2;
		function create2(_2, type, props, key) {
			const isStaticChildren = Array.isArray(props.children);
			const fn = isStaticChildren ? jsxs24 : jsx26;
	...
	function findComponentFromName(state, name2, allowExpression) {
		...
		if (result.type === "Literal") {
			const name3 =
				/** @type {string | number} */
				result.value;
			return own.call(state.components, name3)
				? state.components[name3]
				: name3;
		}
		if (state.evaluater) {
	...
	function decodeNumericCharacterReference(value, base) {
		...
		if (
			...
			code4 < 9 ||
			code4 === 11 ||
			(code4 > 13 && code4 < 32) || // Control character (DEL) of C0, and C1 controls.
			...
			(code4 & 65535) === 65535 ||
			(code4 & 65535) === 65534 /* eslint-enable no-bitwise */ ||
			// Out of range
			code4 > 1114111
		) {
			return "\uFFFD";
	...
	function regexCheck(regex) {
		...
		function check(code4) {
			return (
				code4 !== null && code4 > -1 && regex.test(String.fromCharCode(code4))
			);
		}
	}
	...
	function classifyCharacter(code4) {
		if (
			code4 === null ||
			markdownLineEndingOrSpace(code4) ||
			unicodeWhitespace(code4)
		) {
			return 1;
		}
	...
	function tokenizeAttention(effects, ok3) {
		...
		function inside(code4) {
			...
			const open =
				!after || (after === 2 && before) || attentionMarkers2.includes(code4);
			const close =
				!before ||
				(before === 2 && after) ||
				attentionMarkers2.includes(previous3);
	...
	function tokenizeBlankLine(effects, ok3, nok) {
		return start2;
		function start2(code4) {
			return markdownSpace(code4)
				? factorySpace(effects, after, "linePrefix")(code4)
				: after(code4);
		}
		function after(code4) {
			return code4 === null || markdownLineEnding(code4)
				? ok3(code4)
				: nok(code4);
		}
	}
	...
	function tokenizeCodeFenced(effects, ok3, nok) {
		...
		function sequenceOpen(code4) {
			...
			return markdownSpace(code4)
				? factorySpace(effects, infoBefore, "whitespace")(code4)
				: infoBefore(code4);
		}
		function infoBefore(code4) {
			if (code4 === null || markdownLineEnding(code4)) {
				...
				return self2.interrupt
					? ok3(code4)
					: effects.check(nonLazyContinuation, atNonLazyBreak, after)(code4);
			}
		...
		function contentStart(code4) {
			return initialPrefix > 0 && markdownSpace(code4)
				? factorySpace(
						effects,
						beforeContentChunk,
						"linePrefix",
		...
		function tokenizeCloseStart(effects2, ok4, nok2) {
			...
			function sequenceClose(code4) {
				...
				if (size >= sizeOpen) {
					...
					return markdownSpace(code4)
						? factorySpace(effects2, sequenceCloseAfter, "whitespace")(code4)
						: sequenceCloseAfter(code4);
				}
				return nok2(code4);
			}
	...
	function factoryDestination(
		...
		function raw(code4) {
			if (
				!balance &&
				(code4 === null || code4 === 41 || markdownLineEndingOrSpace(code4))
			) {
				effects.exit("chunkString");
				effects.exit(stringType);
	...
	function factoryLabel(effects, ok3, nok, type, markerType, stringType) {
		...
		function atBreak(code4) {
			if (
				...
				code4 === null ||
				code4 === 91 ||
				(code4 === 93 && !seen) || // To do: remove in the future once we’ve switched from
	...
	function tokenizeDefinition(effects, ok3, nok) {
		...
		function markerAfter(code4) {
			return markdownLineEndingOrSpace(code4)
				? factoryWhitespace(effects, destinationBefore)(code4)
				: destinationBefore(code4);
		}
		...
		function after(code4) {
			return markdownSpace(code4)
				? factorySpace(effects, afterWhitespace, "whitespace")(code4)
				: afterWhitespace(code4);
		}
	...
	function tokenizeTitleBefore(effects, ok3, nok) {
		...
		function titleBefore2(code4) {
			return markdownLineEndingOrSpace(code4)
				? factoryWhitespace(effects, beforeMarker)(code4)
				: nok(code4);
		}
		...
		function titleAfter(code4) {
			return markdownSpace(code4)
				...
				: titleAfterOptionalWhitespace(code4);
		}
		...
		function tagName(code4) {
			if (
				...
				return self2.interrupt && !self2.parser.lazy[self2.now().line]
					? nok(code4)
					: closingTag
						? completeClosingTagAfter(code4)
						: completeAttributeNameBefore(code4);
			}
	...
	function tokenizeResource(effects, ok3, nok) {
		...
		function resourceBefore(code4) {
			return markdownLineEndingOrSpace(code4)
				? factoryWhitespace(effects, resourceOpen)(code4)
				: resourceOpen(code4);
		}
		...
		function resourceDestinationAfter(code4) {
			return markdownLineEndingOrSpace(code4)
				? factoryWhitespace(effects, resourceBetween)(code4)
				: resourceEnd(code4);
		}
		...
		function resourceTitleAfter(code4) {
			return markdownLineEndingOrSpace(code4)
				? factoryWhitespace(effects, resourceEnd)(code4)
				: resourceEnd(code4);
		}
	...
	function tokenizeLabelStartImage(effects, ok3, nok) {
		...
		function after(code4) {
			return code4 === 94 && "_hiddenFootnoteSupport" in self2.parser.constructs
				? nok(code4)
				: ok3(code4);
		}
	}
	...
	function tokenizeThematicBreak(effects, ok3, nok) {
		...
		function sequence(code4) {
			...
			return markdownSpace(code4)
				? factorySpace(effects, atBreak, "whitespace")(code4)
				: atBreak(code4);
		}
	}
	...
	function tokenizeListStart(effects, ok3, nok) {
		...
		function start2(code4) {
			const kind =
				...
				(code4 === 42 || code4 === 43 || code4 === 45
					? "listUnordered"
					: "listOrdered");
			if (
				kind === "listUnordered"
					? !self2.containerState.marker ||
						code4 === self2.containerState.marker
					: asciiDigit(code4)
			) {
				...
				if (kind === "listUnordered") {
					...
					return code4 === 42 || code4 === 45
						? effects.check(thematicBreak, nok, atMarker)(code4)
						: atMarker(code4);
				}
	...
	function tokenizeSetextUnderline(effects, ok3, nok) {
		...
		function inside(code4) {
			...
			return markdownSpace(code4)
				? factorySpace(effects, after, "lineSuffix")(code4)
				: after(code4);
		}
		function after(code4) {
			if (code4 === null || markdownLineEnding(code4)) {
	...
	function createState(tree, options) {
		...
		visit(tree, (node2) => {
			if (node2.type === "definition" || node2.type === "footnoteDefinition") {
				const map3 =
					node2.type === "definition" ? definitionById : footnoteById;
				const id = String(node2.identifier).toUpperCase();
				if (!map3.has(id)) {
					map3.set(id, node2);
				}
	...
	var Processor = class _Processor extends CallableInstance {
		...
		data(key, value) {
			if (typeof key === "string") {
				...
				return (
					(own4.call(this.namespace, key) && this.namespace[key]) || void 0
				);
			}
			if (key) {
				assertUnfrozen("data", this.frozen);
		...
		process(file, done) {
			...
			function executor(resolve, reject) {
				...
				self2.run(parseTree, realFile, (error, tree, file2) => {
					if (error || !tree || !file2) {
			...
			if (node2.type === "element") {
				...
				for (key in urlAttributes) {
					if (
						...
						Object.hasOwn(node2.properties, key)
					) {
						const value = node2.properties[key];
						const test = urlAttributes[key];
						if (test === null || test.includes(node2.tagName)) {
							node2.properties[key] = urlTransform(
								String(value || ""),
								key,
								node2,
							);
	...
	function previous2(match, email) {
		...
		return (
			(match.index === 0 ||
				unicodeWhitespace(code4) ||
				unicodePunctuation(code4)) && // If it’s an email, the previous character should not be a slash.
			(!email || code4 !== 47)
		);
	}
	...
	function listItemWithTaskListItem(node2, parent, state, info) {
		const head = node2.children[0];
		const checkable =
			typeof node2.checked === "boolean" && head && head.type === "paragraph";
	...
	function tokenizeDomain(effects, ok3, nok) {
		...
		function domainInside(code4) {
			...
			if (
				...
				markdownLineEndingOrSpace(code4) ||
				unicodeWhitespace(code4) ||
				(code4 !== 45 && unicodePunctuation(code4))
			) {
	...
	function tokenizeTrail(effects, ok3, nok) {
		...
		function trailCharacterReferenceStart(code4) {
			return asciiAlpha(code4)
				? trailCharacterReferenceInside(code4)
				: nok(code4);
		}
	...
	function tokenizePotentialGfmFootnoteCall(effects, ok3, nok) {
		...
		let index2 = self2.events.length;
		const defined =
			self2.parser.gfmFootnotes || (self2.parser.gfmFootnotes = []);
		let labelStart;
		while (index2--) {
	...
	function tokenizeGfmFootnoteCall(effects, ok3, nok) {
		...
		function callData(code4) {
			...
			if (code4 === 93) {
				...
				if (
					!defined.includes(normalizeIdentifier(self2.sliceSerialize(token)))
				) {
					return nok(code4);
				}
				effects.enter("gfmFootnoteCallLabelMarker");
			...
			if (inDelimiterRow) {
				if (event[0] === "enter") {
					...
					if (events[index2 - 1][1].type === "tableDelimiterMarker") {
						...
						align[alignIndex] =
							align[alignIndex] === "left" ? "center" : "right";
					}
	...
	var MarkdownContent = ({
		...
		const renderPlainText = ({ node: _node, ...props }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", {
			className,
			id,
			children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Markdown, {
				components: {
					...
					p: ({ node: _node, ...props }) =>
						/* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { ...props }),
					strong: allowEmphasis
						? ({ node: _node, ...props }) =>
								/* @__PURE__ */ (0, import_jsx_runtime15.jsx)("strong", {
									...props,
								})
						: renderPlainText,
					em: allowEmphasis
						? ({ node: _node, ...props }) =>
								/* @__PURE__ */ (0, import_jsx_runtime15.jsx)("em", {
									...props,
								})
						: renderPlainText,
				},
	...
	var DialogPanel = ({
		...
		const [expandedThinking, setExpandedThinking] = (0,
		import_react14.useState)({});
		const [pinnedToBottom, setPinnedToBottom] = (0, import_react14.useState)(
			true,
		);
		...
		if (displayMessages.length === 0) {
			return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", {
				className: "session-dialog session-panel",
				children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", {
					className: "session-dialog__empty",
	...
	var ThinkingMessage = ({ message, expanded, onToggle, label, className }) =>
		/* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("article", {
			className,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("header", {
					className:
						"session-dialog__message-header session-dialog__message-header--thinking",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", {
							className: "session-dialog__role",
							children: label,
						}),
					],
				}),
				expanded
					? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
							markdown_content_default,
							{
								allowEmphasis: false,
								className:
									"session-dialog__content session-dialog__content--thinking session-dialog__content--thinking-expanded",
								content: message.content,
	...
	var StandardMessage = ({ message, label, className }) => {
		const messageDate = new Date(message.createdAt);
		return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("article", {
			className,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("header", {
					className: "session-dialog__message-header",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", {
							className: "session-dialog__role",
							children: label,
						}),
						/* @__PURE__ */ (0, import_jsx_runtime16.jsx)("time", {
...
${message.content}`,
	...
	var InfoPanel = ({ binding }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("section", {
			className: "session-panel session-info",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", {
					className: "session-status__row",
...
${formattedPaths}`;
		...
		isValidPath(path2) {
			...
			return (
				path2.startsWith("/") ||
				WINDOWS_PATH_PATTERN2.test(path2) ||
				WINDOWS_POSIX_PATTERN.test(path2)
			);
		}
	};
...
${path2}`
		...
		return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("form", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime19.jsx)("textarea", {
							"aria-multiline": "true",
							className: [
						...
						isDragging &&
							/* @__PURE__ */ (0, import_jsx_runtime19.jsx)("output", {
								className: "session-input__overlay",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime20.jsx)("button", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
									"span",
									{
										className: "session-tab__providers",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", {
												className:
													"session-tab__providers-line session-tab__providers-line--primary",
												children: displaySummary[0],
											}),
											displaySummary[1]
												? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
														"span",
														{
															className: "session-tab__providers-line",
															children: displaySummary[1],
														},
													)
												: null,
										],
	...
	var StatusPanel = ({ status, connectionStatus, connectionDetail }) => {
		if (!status || connectionStatus !== "ready") {
			return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("section", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", {
								className: "session-status__label",
								children: SUPERVISOR_LABEL,
							}),
							/* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", {
								className: "session-status__value",
								children: describeConnectionStatus(connectionStatus),
							}),
						],
					}),
					connectionDetail
						? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", {
								className: "session-status__row session-status__row--muted",
	...
	var TodoPanel = ({ items, onToggle }) => {
		const [showActiveOnly, setShowActiveOnly] = (0, import_react16.useState)(
			false,
		);
		...
		return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("section", {
			className: "session-todos session-panel",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("header", {
					className: "session-todos__header",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", {
							className: "session-todos__title-group",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime22.jsx)("h2", {
									className: "session-todos__title",
									children: "Session TODO",
								}),
								/* @__PURE__ */ (0, import_jsx_runtime22.jsx)("button", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
										...
										{
											"aria-hidden": true,
											className: "session-todos__toggle-icon",
											children: "\u25BE",
										},
									),
								}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("span", {
							className: "session-todos__counter",
							children: [completedCount, "/", items.length, " done"],
						}),
					],
				}),
				/* @__PURE__ */ (0, import_jsx_runtime22.jsx)("ul", {
					className: "session-todos__list",
					children:
						visibleItems.length === 0
							? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("li", {
									className: "session-todos__empty",
							...
							: visibleItems.map((item) => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
										"li",
										{
											className: "session-todos__item",
											children: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
												"label",
												{
													className: "session-todos__label",
													children: [
	...
	var SessionView = ({
		...
		return /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", {
			...
			children: [
				...
				activeSession && activeSessionId
					? /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", {
							className: "session-app__content",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", {
									className: "session-app__dialog",
									children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
											todo_panel_default,
											{
												...
												onToggle: (todoId) =>
													onToggleTodo(activeSessionId, todoId),
											},
										),
										/* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
											input_panel_default,
											{
												...
												onSubmit: (text7) =>
													onSendMessage(activeSessionId, text7),
											},
										),
										/* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
	...
	var AppHost = () => {
		const [coreStatus, setCoreStatus] = (0, import_react17.useState)(
			"connecting",
		);
		const [coreStatusDetail, setCoreStatusDetail] = (0,
		import_react17.useState)(void 0);
		const [coreFinalized, setCoreFinalized] = (0, import_react17.useState)(
			false,
		);
		const [messages, setMessages] = (0, import_react17.useState)(
			createDefaultMessages,
		);
		const [activeMessageIndex, setActiveMessageIndex] = (0,
		...
		useWebviewMessageHandler({
			...
			onCoreLoadingStatus: (status) => {
				...
				const scopeValue =
					typeof status.scope === "string" ? status.scope : void 0;
		...
		const { headlineText, statusLine, detailLine } = (0,
		import_react17.useMemo)(() => {
			if (coreStatus === "error") {
				return {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", {
			className: "app-shell",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime24.jsx)(action_bar_default, {
					disabled: !isCoreReady,
				}),
				/* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", {
					className: "app-shell__session-region",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime24.jsx)(ProviderPicker, {
				...
				isCoreReady
					...
					: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", {
							className: "app-shell__status-overlay",
							children: /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
								"output",
								{
									"aria-live": "polite",
									className: "app-shell__status-card",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", {
											"aria-hidden": "true",
											className: "app-shell__status-indicator",
										}),
										/* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("span", {
											className: "app-shell__status-text",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", {
													className: "app-shell__status-line",
												...
												detailLine
													? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
															...
															{
																className:
																	"app-shell__status-line app-shell__status-line--muted",
																children: detailLine,
															},
														)
													: null,
	...
	var mount = () => {
		...
		root4.render(
			/* @__PURE__ */ (0, import_jsx_runtime25.jsx)(import_react18.StrictMode, {
