...
`;
  ...
  var useSettingsVisibility = () => {
    const [settingsVisible, setSettingsVisible] = (0, import_react2.useState)(false);
    const openSettings = (0, import_react2.useCallback)(() => {
      setSettingsVisible(true);
    }, []);
    const closeSettings = (0, import_react2.useCallback)(() => {
  ...
  var LocalizationContext = (0, import_react3.createContext)(
    DEFAULT_LOCALIZATION_RUNTIME
  );
  var useResolvedLocalization = (settings, payload = null) => (0, import_react3.useMemo)(
  ...
  var LocalizationProvider = ({
    children,
    value
  }) => (0, import_react3.createElement)(LocalizationContext.Provider, { value }, children);
  ...
  var AppHost = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SettingsOnlyHost, {});
  ...
  var mount = () => {
    ...
    root.render(
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react6.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(app_host_default, {}) })
    );
  };
  mount();
})();
