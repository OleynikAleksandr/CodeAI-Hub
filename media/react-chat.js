...
(() => {
      ...
      "label",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "provider-picker__label", children: [
            ...
            warning ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "provider-picker__warning", children: warning }) : null
          ] })
        ]
      }
    );
  ...
  var ProviderPicker = ({
    ...
    const renderOption = (provider, index2) => {
      const refCallback = index2 === 0 ? (element3) => {
        firstOptionRef.current = element3;
      } : void 0;
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { className: "provider-picker__form", onSubmit: handleSubmit, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("fieldset", { className: "provider-picker__fieldset", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "provider-picker__options", children: providers.map((provider, index2) => renderOption(provider, index2)) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "provider-picker__actions", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("output", { "aria-live": "polite", className: "provider-picker__status", children: selectionMessage }),
  ...
  var formatModelDisplayName = (modelId) => {
    return modelId.split("-").map((part, index2) => {
      ...
      return index2 === 0 || part.length > 2 ? part.charAt(0).toUpperCase() + part.slice(1) : part.toUpperCase();
    }).join(" ").replace(VERSION_JOIN_REGEX, "$1.$2");
  };
  var buildModelInfoList = (providerIds, settings) => {
    if (!settings) {
  ...
  var isProviderDescriptorCandidate = (value) => {
    ...
    const hasValidStatusMessage = candidate.statusMessage === void 0 || candidate.statusMessage === null || typeof candidate.statusMessage === "string";
    return typeof candidate.title === "string" && typeof candidate.description === "string" && typeof candidate.connected === "boolean" && hasValidStatusMessage;
  };
  var parseProviderList = (candidates) => {
  ...
  var createInitialSnapshot = (session, providerLabels, settings) => {
  ...
  var createServerMessageHandler = (notify) => {
    ...
    return (raw) => {
      ...
      const handler = handlers2[envelope.type];
  ...
  var useProviderPickerState = () => {
    ...
    const openPicker = (0, import_react2.useCallback)(
      (providers) => {
        setCatalog((previous3) => mergeCatalog(previous3, providers));
        setPickerState({
          visible: true,
          providers
        });
  ...
  function productionCreate(_, jsx42, jsxs39) {
    return create2;
    function create2(_2, type, props, key) {
      const isStaticChildren = Array.isArray(props.children);
      const fn = isStaticChildren ? jsxs39 : jsx42;
...
${path2}` : path2;
  ...
  var StatusPanel = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("section", { className: "session-status session-panel", children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "session-status__row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "session-status__label", children: "Models" }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "session-status__value", children: modelsSummary })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "session-status__row", children: [
  ...
  var flowStageButtonActiveStyles = {
    borderColor: "#0e639c",
    background: "#1f2a33"
  };
  ...
  var flowStageTitleStyles = {
    fontSize: "13px",
    fontWeight: 600
  };
  var flowStageSubtitleStyles = {
    fontSize: "11px",
    color: "#a7a7a7",
    lineHeight: 1.4,
    margin: 0
  ...
  var FlowStage = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
      "button",
      {
        ...
        type: "button",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { style: flowStageTitleStyles, children: title }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { style: flowStageSubtitleStyles, children: subtitle })
        ]
      }
    );
  };
  ...
  var FlowWizard = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { style: headingStyles, children: "Start" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: flowWizardStagesRowStyles, children: STAGES.map((stage) => {
  ...
  var FlowWizardPicker = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "provider-picker", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "provider-picker__actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("output", { "aria-live": "polite", className: "provider-picker__status", children: statusMessage }),
  ...
  var QuestionBlock = ({
    ...
    const [userMinHeight, setUserMinHeight] = (0, import_react9.useState)(null);
    const textareaRef = (0, import_react9.useRef)(null);
    const containerRef = (0, import_react9.useRef)(null);
    const lastWidthRef = (0, import_react9.useRef)(null);
    const adjustTextareaHeight2 = (0, import_react9.useCallback)(() => {
      const textarea = textareaRef.current;
      if (!textarea) {
        return;
      }
    ...
    const handleResizeCommit = (0, import_react9.useCallback)(() => {
      const textarea = textareaRef.current;
      if (!textarea) {
        return;
      }
    ...
    const insertTextAtSelection = (0, import_react9.useCallback)(
      (text7) => {
        const textarea = textareaRef.current;
        if (!textarea) {
          return;
    ...
    const syncTextareaValue = (0, import_react9.useCallback)(() => {
      const textarea = textareaRef.current;
      if (!textarea) {
        return;
      }
    ...
    const { handlePaste, handleCopy } = (0, import_react9.useMemo)(
      () => createClipboardHandlers({
        textareaRef,
        insertTextAtSelection,
        syncTextareaValue
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("section", { style: questionCardStyles, children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: questionHeaderStyles, children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: questionTitleRowStyles, children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: questionTitleStyles, children: question.title }),
          question.titleHint ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: questionTitleHintStyles, children: question.titleHint }) : null
        ] }),
        question.description ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { style: questionDescriptionStyles, children: question.description }) : null,
        question.hint ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { style: questionHintStyles, children: question.hint }) : null
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { ref: containerRef, style: inputShellStyles, children: [
        ...
        isDragging ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("output", { style: questionOverlayStyles, children: DEFAULT_DRAG_OVERLAY_LABEL }) : null
      ] })
    ] });
  };
  ...
  var IdeaQuestionnaireView = ({
    ...
    onSubmit,
    onCancel
  }) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("section", { "aria-label": "Idea questionnaire", style: questionnairePageStyles, children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("header", { style: questionnaireHeaderStyles, children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("h1", { style: questionnaireTitleStyles, children: title }),
      description ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { style: questionnaireDescriptionStyles, children: description }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: questionnaireListStyles, children: questions.map((question) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      QuestionBlock,
      {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: questionnaireFooterStyles, children: [
...
<!-- /field -->`
  ...
  var DESCRIPTION_PATH_RE = /^\.codeai-hub\/([^/]+)\/description\/description\.md$/;
  var DESCRIPTION_RUN_PATH_RE = /^\.codeai-hub\/([^/]+)\/description\/runs\/([^/]+)\/description\.md$/;
  var LEGACY_IDEA_PATH_RE = /^\.codeai-hub\/([^/]+)\/description\/idea\/idea\.md$/;
...
<!-- /field -->`;
  ...
  var QuestionnaireResumeBanner = ({
    note,
    resumeLabel,
    onResume
  }) => /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { style: containerStyles, children: [
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { children: note }),
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("button", { onClick: onResume, style: buttonStyles, type: "button", children: resumeLabel })
  ] });
  ...
  var loadQuestionnaireForSession = (questionnaireService, sessions, sessionId) => {
    ...
    if (!outputPaths) {
      postSystemNotice(
        sessionId,
        "\u041D\u0435 \u043C\u043E\u0433\u0443 \u043E\u0442\u043A\u0440\u044B\u0442\u044C \u0430\u043D\u043A\u0435\u0442\u0443: Core \u0435\u0449\u0435 \u043D\u0435 \u0432\u0435\u0440\u043D\u0443\u043B initiative \u043A\u043E\u043D\u0442\u0435\u043A\u0441\u0442. \u041F\u043E\u0434\u043E\u0436\u0434\u0438\u0442\u0435 \u0438 \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u0412\u043E\u0437\u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0430\u043D\u043A\u0435\u0442\u0443\xBB."
      );
  ...
  var IdeaQuestionnairePanel = ({
    ...
    const ideaCollectorRef = (0, import_react10.useRef)(new IdeaCollectorService());
    const questionnaireServiceRef = (0, import_react10.useRef)(new IdeaQuestionnaireService());
    const [questionnaireSnapshot, setQuestionnaireSnapshot] = (0, import_react10.useState)(null);
    const [questionnaireVisible, setQuestionnaireVisible] = (0, import_react10.useState)(false);
    const ideaCollector = ideaCollectorRef.current;
    const questionnaireService = questionnaireServiceRef.current;
    const handleAnswerChange = (0, import_react10.useCallback)(
      (questionId, value) => {
    ...
    const handleQuestionnaireSubmit = (0, import_react10.useCallback)(async () => {
    ...
    const handleQuestionnaireCancel = (0, import_react10.useCallback)(() => {
      if (!questionnaireSnapshot) {
        setQuestionnaireVisible(false);
        return;
      }
    ...
    const handleQuestionnaireResume = (0, import_react10.useCallback)(() => {
      if (!activeSessionId) {
        return;
      }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
      showQuestionnaireResume ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      ...
      showQuestionnaire && questionnaireSnapshot ? /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
  ...
  var SessionRegion = ({
    ...
    const [questionnaireActive, setQuestionnaireActive] = (0, import_react11.useState)(false);
  ...
  var useSettingsModelsSync = (sessions, settings, setSnapshots) => {
    (0, import_react12.useEffect)(() => {
      ...
      setSnapshots((previous3) => {
        ...
        for (const session of sessions) {
          const snapshot = previous3[session.id];
          if (!snapshot) {
            continue;
          }
          const newModels = buildModelInfoList(session.providerIds, settings);
          const modelsChanged = JSON.stringify(newModels) !== JSON.stringify(snapshot.status.models);
          if (modelsChanged) {
            hasChanges = true;
            next[session.id] = {
              ...snapshot,
        ...
        return hasChanges ? next : previous3;
      });
  ...
  var useSessionStore = (providerLabels, settings) => {
    ...
    const handleSessionBindingUpdate = (0, import_react13.useCallback)(
      (payload) => {
        ...
        setSnapshots((previous3) => {
          const current = previous3[payload.sessionId];
          if (!current) {
            pendingBindingsRef.current[payload.sessionId] = binding;
            return previous3;
          }
    ...
    const handleSessionDeleted = (0, import_react13.useCallback)(
      (payload) => {
        ...
        setSessions((previous3) => {
          const next = previous3.filter((session) => session.id !== sessionId);
          syncSessionsRef(next);
          return next;
        });
        setSnapshots((previous3) => removeSnapshot(previous3, sessionId));
        setActiveSessionId((current) => {
  ...
  var SettingsCard = ({
    ...
    action,
    children
  }) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: cardStyles, children: [
    title ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: headerStyles, children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("h3", { style: titleStyles, children: title }),
      action
    ] }) : null,
    children
  ] });
  ...
  var ClaudeDefaultModelCard = ({
    ...
    const [hoveredAlias, setHoveredAlias] = (0, import_react14.useState)(
      null
    );
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(settings_card_default, { title: "Claude Default model", children: [
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("p", { style: descriptionStyles, children: "Choose the Claude alias that will be applied when new sessions start. More details in the knowledge base: doc/Knowledge/Claude_Model_Aliases.md" }),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: listStyles, children: CLAUDE_MODEL_ALIASES.map((model) => {
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", { style: modelInfoStyles, children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: aliasStyles, children: model.alias }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("p", { style: noteStyles, children: "Applies only to newly created Claude sessions." })
    ] });
  };
  var claude_default_model_card_default = (0, import_react14.memo)(ClaudeDefaultModelCard);
  ...
  var optionDescriptionStyles = {
    fontSize: "12px",
    color: "#b6b6b6",
    margin: 0,
    lineHeight: 1.4
  };
  var optionUseCaseStyles = {
    fontSize: "12px",
    color: "#8f8f8f",
    margin: "6px 0 0"
  };
  ...
  var CodexReasoningDialog = ({
    ...
    const [selectedReasoning, setSelectedReasoning] = (0, import_react15.useState)(initialReasoning);
    return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { style: overlayStyles, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
      "div",
      {
        ...
        style: dialogStyles,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: headerStyles2, children: [
            /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("h3", { style: titleStyles2, children: [
                model.displayName,
                " reasoning"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("p", { style: subtitleStyles, children: "Choose how much reasoning effort Codex should apply for this model. Changes take effect when starting a new session." })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("button", { onClick: onCancel, style: closeButtonStyles, type: "button", children: "Close" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { style: optionListStyles, children: CODEX_REASONING_LEVELS.map((level) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
              "label",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: optionTitleStyles, children: [
                      level.name,
                      level.default ? /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("span", { style: defaultBadgeStyles, children: "Default" }) : null
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("p", { style: optionDescriptionStyles, children: level.description }),
                    /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("p", { style: optionUseCaseStyles, children: [
                      "Use case: ",
                      level.useCase
                    ] })
                  ] })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("div", { style: footerStyles, children: [
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("button", { onClick: onCancel, style: cancelButtonStyles, type: "button", children: "Cancel" }),
            /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
              "button",
              {
  ...
  var RadioCircle = ({ checked }) => /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
    "div",
    {
      style: {
        ...radioCircleStyles,
      ...
      children: checked ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { style: radioCircleInnerStyles }) : null
    }
  );
  var CodexDefaultModelCard = ({
    ...
    const [activeModelId, setActiveModelId] = (0, import_react16.useState)(null);
    ...
    const recommendedModelIds = (0, import_react16.useMemo)(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(settings_card_default, { title: "Codex Default model", children: [
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { style: descriptionStyles, children: "Select which Codex model to use when starting new sessions. Each model can store its own reasoning effort level." }),
        hasUnsupportedModel ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { style: warningStyles, children: "The saved default model is no longer available. Falling back to GPT-5.2-Codex." }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { style: listStyles, children: CODEX_RECOMMENDED_MODELS.map((model) => {
          ...
          return (
            ...
            /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
              "div",
              {
                ...
                tabIndex: -1,
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(RadioCircle, { checked: isSelected }),
                  /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { style: modelBodyStyles, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { style: modelInfoStyles, children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("div", { style: modelIdStyles, children: model.id }),
                      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { style: modelDescriptionStyles, children: model.description })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)("div", { style: reasoningRowStyles, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("span", { style: reasoningLabelStyles, children: "Configure reasoning:" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("p", { style: noteStyles, children: "Changes apply when creating a new Codex session." })
      ] }),
      activeModel ? /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(
  ...
  var codex_default_model_card_default = (0, import_react16.memo)(CodexDefaultModelCard);
  ...
  var GeminiThinkingDialog = ({
    ...
    const [selectedLevel, setSelectedLevel] = (0, import_react17.useState)(initialLevel);
    return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: overlayStyles2, children: /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
      "div",
      {
        ...
        style: dialogStyles2,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { style: headerStyles3, children: [
            /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("h3", { style: titleStyles3, children: [
                model.displayName,
                " thinking"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { style: subtitleStyles2, children: "Choose how much reasoning depth Gemini should apply for this model. Changes take effect when starting a new session." })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("button", { onClick: onCancel, style: closeButtonStyles2, type: "button", children: "Close" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("div", { style: optionListStyles2, children: GEMINI_THINKING_LEVELS.filter(
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(
              "label",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { style: optionTitleStyles2, children: [
                      level.name,
                      level.name === DEFAULT_GEMINI_THINKING_LEVEL ? /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("span", { style: defaultBadgeStyles2, children: "Default" }) : null
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("p", { style: optionDescriptionStyles2, children: level.description }),
                    /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("p", { style: optionUseCaseStyles2, children: [
                      "Use case: ",
                      level.useCase
                    ] })
                  ] })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)("div", { style: footerStyles2, children: [
            /* @__PURE__ */ (0, import_jsx_runtime24.jsx)("button", { onClick: onCancel, style: cancelButtonStyles2, type: "button", children: "Cancel" }),
            /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
              "button",
              {
  ...
  var RadioCircle2 = ({ checked }) => /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
    "div",
    {
      style: {
        ...radioCircleStyles,
  ...
  var GeminiDefaultModelCard = ({
    ...
    const [activeModelId, setActiveModelId] = (0, import_react18.useState)(
      null
    );
    const [hoveredRowId, setHoveredRowId] = (0, import_react18.useState)(null);
    const [hoveredButtonId, setHoveredButtonId] = (0, import_react18.useState)(
      null
    );
    const [pressedButtonId, setPressedButtonId] = (0, import_react18.useState)(
      null
    );
    ...
    const handleThinkingButtonClick = (event, modelId) => {
      event.stopPropagation();
      setActiveModelId(modelId);
    };
    return /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(settings_card_default, { title: "Gemini Default model", children: [
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { style: descriptionStyles, children: "Select the Gemini model to use for new sessions. Each model can store its own thinking level. More details in the knowledge base: doc/Knowledge/Gemini_Model_Selection.md" }),
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { style: listStyles, children: GEMINI_RECOMMENDED_MODELS.map((model) => {
          ...
          return (
            ...
            /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)(
              "div",
              {
                ...
                tabIndex: -1,
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(RadioCircle2, { checked: isSelected }),
                  /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { style: modelBodyStyles2, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { style: modelInfoStyles, children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { style: modelIdStyles2, children: model.id }),
                      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { style: modelDescriptionStyles, children: model.description })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { style: reasoningRowStyles2, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("span", { style: reasoningLabelStyles2, children: "Configure thinking:" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { style: noteStyles, children: "Applies only to newly created Gemini sessions." })
      ] }),
  ...
  var gemini_default_model_card_default = (0, import_react18.memo)(GeminiDefaultModelCard);
  ...
  var GeneralSettings = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { style: wrapperStyles, children: /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(settings_card_default, { title: "Core Controls", children: [
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("p", { style: descriptionStyles2, children: "Restart the CodeAI Hub core to trigger a fresh CLI detection cycle. Use this option after resolving CLI authentication or quota issues." }),
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("button", { onClick: handleRestartCore, style: buttonStyles2, type: "button", children: "Restart Core" })
    ] }) });
  };
  var general_settings_default = (0, import_react19.memo)(GeneralSettings);
  ...
  var VersionRowItemComponent = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: rowStyles, children: [
      /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("div", { style: labelStyles, children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("p", { style: nameStyles, children: row.label }),
        /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("p", { style: versionTextStyles, children: [
          "Current: ",
          currentLabel,
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { style: chipStyles, children: latestLabel })
        ] })
      ] }),
      row.target && shouldShowButton ? /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(
        "button",
        {
  ...
  var VersionRowItem = (0, import_react20.memo)(VersionRowItemComponent);
  ...
  var WarningBanner = ({
    provider
  }) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { style: { ...warningStyles2, ...providerBannerStyles(provider) }, children: "Warning: Updating is at your own risk. New versions may be incompatible. Updating will close active sessions." });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(
      "label",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { style: { flex: 1 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { style: toggleTitleStyles, children: [
              "Auto-update ",
              providerLabel
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("p", { style: toggleDescriptionStyles, children: [
  ...
  var ProviderVersions = ({
    ...
    const [pendingTarget, setPendingTarget] = (0, import_react21.useState)(null);
    const snapshot = versions.data;
    const rows = (0, import_react21.useMemo)(() => {
      if (!snapshot) {
        return [];
      }
      if (provider === "gemini") {
    ...
    const hasProviderVersions = (0, import_react21.useMemo)(() => {
      if (!snapshot) {
        return false;
      }
      if (provider === "gemini") {
    ...
    const providerUpdateTargets = (0, import_react21.useMemo)(() => {
    ...
    const manualUpdateStatus = (0, import_react21.useMemo)(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)(
      ...
      {
        action: snapshot?.checkedAt ? /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("span", { style: metadataTextStyles, children: [
          "Checked: ",
          formatCheckedAt(snapshot.checkedAt) ?? snapshot.checkedAt
        ] }) : null,
        title,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(WarningBanner, { provider }),
          ...
          versions.error ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { style: errorStyles, children: versions.error }) : null,
          versions.loading && !hasProviderVersions ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { style: statusStyles, children: "Loading version information\u2026" }) : null,
          pendingTarget ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { style: statusStyles, children: "Click the highlighted button again to confirm update. Active sessions will close." }) : null,
          manualUpdateStatus ? /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { style: statusStyles, children: manualUpdateStatus }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("div", { style: rowsContainerStyles, children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
            VersionRowItem,
            {
              disabled: isBusy,
  ...
  var provider_versions_default = (0, import_react21.memo)(ProviderVersions);
  ...
  var SettingsFooter = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { style: containerStyles2, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { style: buttonGroupStyles, children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
          "button",
          {
  ...
  var SettingsHeader = ({ onClose }) => /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)("div", { style: headerStyles4, children: [
    /* @__PURE__ */ (0, import_jsx_runtime31.jsx)("div", { style: titleStyles4, children: "Settings" }),
...
`;
  ...
  var ThinkingProTip = () => /* @__PURE__ */ (0, import_jsx_runtime32.jsxs)("div", { style: containerStyles3, children: [
    /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { style: titleStyles5, children: "\u{1F4A1} Pro Tip" }),
    /* @__PURE__ */ (0, import_jsx_runtime32.jsx)("div", { style: descriptionStyles3, children: 'Use "Ultrathink" anywhere in your message to enable maximum thinking (32000 tokens) for that specific query, regardless of your current settings.' })
  ] });
  ...
  var ThinkingToggle = ({ enabled, onToggle }) => /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("label", { style: toggleContainerStyles2, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { style: { flex: 1 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("div", { style: titleStyles6, children: "Enable thinking mode" }),
      /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)("div", { style: descriptionStyles4, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime33.jsx)("strong", { style: noteStyles2, children: "Note:" }),
  ...
  var ThinkingTokenInput = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { style: containerStyles4, children: /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("label", { style: { display: "block" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", { style: titleStyles7, children: "Maximum thinking tokens" }),
      /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("div", { style: controlsStyles, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("div", { style: helperStyles, children: [
  ...
  var ThinkingSettings = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)("div", { style: wrapperStyles2, children: [
      /* @__PURE__ */ (0, import_jsx_runtime35.jsx)("style", { children: hideSpinnerStyle }),
      /* @__PURE__ */ (0, import_jsx_runtime35.jsxs)(settings_card_default, { title: "Claude Thinking Settings", children: [
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(thinking_toggle_default, { enabled, onToggle: handleToggle }),
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(thinking_token_input_default, { onChange: handleTokenChange, value: maxTokens }),
        /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(thinking_pro_tip_default, {})
      ] })
    ] });
  };
  var thinking_settings_default = (0, import_react22.memo)(ThinkingSettings);
  ...
  var updateClaudeDefaultModel = (settings, modelId) => ({
    ...settings,
    providers: {
      ...settings.providers,
      claude: {
  ...
  var updateCodexReasoning = (settings, modelId, reasoning) => ({
    ...settings,
    providers: {
      ...settings.providers,
      codex: {
  ...
  var useSettingsState = () => {
    const initialSettingsRef = (0, import_react23.useRef)(createDefaultSettings());
    const [settings, setSettings] = (0, import_react23.useState)(createDefaultSettings);
    ...
    const updateSettings = (0, import_react23.useCallback)((nextSettings) => {
      setSettings(nextSettings);
      setHasChanges(!areSettingsEqual(nextSettings, initialSettingsRef.current));
    }, []);
    const handleThinkingSettingsChange = (0, import_react23.useCallback)(
      (enabled, maxTokens) => {
        updateSettings(updateThinkingSettings(settings, enabled, maxTokens));
      },
      [settings, updateSettings]
    );
    const handleClaudeDefaultModelChange = (0, import_react23.useCallback)(
      (modelId) => {
    ...
    const handleCodexReasoningChange = (0, import_react23.useCallback)(
      (modelId, reasoning) => {
        updateSettings(updateCodexReasoning(settings, modelId, reasoning));
      },
      [settings, updateSettings]
    );
    const handleProviderAutoUpdateChange = (0, import_react23.useCallback)(
      (provider, enabled) => {
        updateSettings(updateProviderAutoUpdate(settings, provider, enabled));
      },
      [settings, updateSettings]
    );
    const handleGeminiDefaultModelChange = (0, import_react23.useCallback)(
      (modelId) => {
        updateSettings(updateGeminiDefaultModel(settings, modelId));
      },
      [settings, updateSettings]
    );
    const handleGeminiThinkingChange = (0, import_react23.useCallback)(
      (modelId, level) => {
        updateSettings(updateGeminiThinking(settings, modelId, level));
      },
      [settings, updateSettings]
    );
    const handleSave = (0, import_react23.useCallback)(() => {
      setSaving(true);
      vscode_default.postMessage({
        type: "settings:save",
        settings
    ...
    const handleReset = (0, import_react23.useCallback)(() => {
      setResetting(true);
      window.setTimeout(() => {
        vscode_default.postMessage({
          type: "settings:reset"
    ...
    const handleUpdateProvider = (0, import_react23.useCallback)(
      (provider, target) => {
        const targetKey = `${provider}:${target}`;
        setVersions((prev) => ({
          ...prev,
          updatingTargets: [.../* @__PURE__ */ new Set([...prev.updatingTargets, targetKey])]
        }));
        vscode_default.postMessage({
  ...
  var SettingsView = ({
    ...
    const [activeTab, setActiveTab] = (0, import_react24.useState)("claude");
    const {
      settings,
      hasChanges,
      saving,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { style: containerStyles5, children: [
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(settings_header_default, { onClose }),
      mode === "settings-only" ? /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { style: modeNoticeStyles, children: [
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { style: modeNoticeTitleStyles, children: "Settings only mode" }),
        /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { children: "Sessions and chats are available in Project Manager." })
      ] }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { style: tabBarStyles, children: settingsTabs.map((tab2) => /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
        "button",
        {
          onClick: () => setActiveTab(tab2.id),
          style: {
            ...tabButtonStyles,
            ...activeTab === tab2.id ? activeTabStyles : null
          },
          type: "button",
          children: tab2.label
        },
      ...
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { style: contentStyles, children: (() => {
        if (activeTab === "claude") {
          return /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { style: stackStyles, children: [
        ...
        if (activeTab === "general") {
          return /* @__PURE__ */ (0, import_jsx_runtime36.jsx)("div", { style: stackStyles, children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(general_settings_default, {}) });
        }
        if (activeTab === "codex") {
          return /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)("div", { style: stackStyles, children: [
            /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
  ...
  var settings_view_default = import_react24.default.memo(SettingsView);
  ...
  var useSettingsVisibility = () => {
    const [settingsVisible, setSettingsVisible] = (0, import_react25.useState)(false);
    const openSettings = (0, import_react25.useCallback)(() => {
      setSettingsVisible(true);
    }, []);
    const closeSettings = (0, import_react25.useCallback)(() => {
  ...
  var dispatchSessionMessage = (message, handlers2) => {
    switch (message.type) {
      case "session:created":
        handleSessionCreatedMessage(message, handlers2.onSessionCreated);
        return true;
      case "session:clearAll":
        handlers2.onSessionClearAll();
        return true;
      case "session:focusLast":
        handlers2.onSessionFocusLast();
        return true;
      case "session:message":
        handleSessionMessageEvent(message, handlers2.onSessionMessage);
        return true;
      case "session:deleted":
        handleSessionDeletedMessage(message, handlers2.onSessionDeleted);
        return true;
      case "session:binding":
        handleSessionBindingMessage(message, handlers2.onSessionBinding);
        return true;
  ...
  var dispatchWebviewMessage = (rawMessage, handlers2) => {
    if (!isIncomingMessage2(rawMessage)) {
      return;
    }
    const message = rawMessage;
    if (dispatchSessionMessage(message, {
      onSessionCreated: handlers2.onSessionCreated,
      onSessionClearAll: handlers2.onSessionClearAll,
      onSessionFocusLast: handlers2.onSessionFocusLast,
    ...
    switch (message.type) {
      case "core:connection": {
        if (handlers2.onCoreConnectionStatus && message.payload) {
          const candidate = message.payload;
          const status = candidate.status;
          if (typeof status === "string") {
            const detail = typeof candidate.detail === "string" ? candidate.detail : void 0;
            handlers2.onCoreConnectionStatus(status, detail);
          }
        }
        return;
      }
      case "providerPicker:open":
        handleProviderPickerOpenMessage(message, handlers2.onProviderPickerOpen);
        return;
      case "ui:showSettings":
        handlers2.onShowSettings();
        return;
      case "core:state":
        handleCoreStateMessage(message, handlers2.onCoreState);
        return;
      case "core:loading-status":
        handleCoreLoadingStatusMessage(message, handlers2.onCoreLoadingStatus);
        return;
      default:
        return;
    }
  ...
  var noopProviderPickerOpen = () => {
  };
  var noopSessionCreated = () => {
  };
  var noopVoidHandler = () => {
  };
  var SettingsOnlyHost = () => {
    const { settingsVisible, openSettings, closeSettings } = useSettingsVisibility();
    const handleShowSettings = (0, import_react27.useCallback)(() => {
      activateRoot();
      openSettings();
    }, [openSettings]);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)("div", { className: "app-shell", children: [
      /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("main", { "aria-label": "Settings only mode", style: settingsOnlyLayoutStyles, children: /* @__PURE__ */ (0, import_jsx_runtime37.jsxs)("section", { style: settingsOnlyCardStyles, children: [
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("h1", { style: settingsOnlyTitleStyles, children: "Settings only" }),
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("p", { style: settingsOnlyBodyStyles, children: "Sessions and chats are available in Project Manager." }),
        /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("p", { style: settingsOnlyHintStyles, children: "Use this panel to configure providers and defaults." }),
      ...
      settingsVisible ? /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("div", { className: "settings-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)("div", { className: "settings-overlay__panel", children: /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(settings_view_default, { mode: "settings-only", onClose: closeSettings }) }) }) : null
    ] });
  };
  ...
  var useIdeaCollector = (fallbackSendMessage) => {
    const serviceRef = (0, import_react28.useRef)(new IdeaCollectorService());
    const questionnaireServiceRef = (0, import_react28.useRef)(new IdeaQuestionnaireService());
    ...
    const startCollection = (0, import_react28.useCallback)(
      (sessionId) => {
        service.startCollection(sessionId);
      },
      [service]
    );
    const sendMessage = (0, import_react28.useCallback)(
      (sessionId, content3) => {
  ...
  var useProviderPickerOpenHandler = (openPicker, selectStage, lockStageSelection) => (0, import_react29.useCallback)(
    (providers, stage) => {
      activateRoot();
      if (providers.length === 0) {
        return;
  ...
  var ActionBarContextForm = ({
    ...
    mode ? /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("form", { className: "action-bar__context-form", onSubmit, children: [
      /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("span", { className: "action-bar__context-form-title", children: title }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime38.jsxs)("div", { className: "action-bar__context-form-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime38.jsx)(
          "button",
          {
    ...
    statusMessage ? /* @__PURE__ */ (0, import_jsx_runtime38.jsx)("output", { "aria-live": "polite", className: "action-bar__context-status", children: statusMessage }) : null
  ] });
  ...
  var useInitiativeContext = (disabled) => {
    const [initiatives, setInitiatives] = (0, import_react30.useState)([]);
    const [selectedInitiativeSlug, setSelectedInitiativeSlug] = (0, import_react30.useState)(null);
    const [statusMessage, setStatusMessage] = (0, import_react30.useState)(null);
    const coreHttpUrl = (0, import_react30.useMemo)(() => resolveCoreHttpUrl(), []);
    const workspacePath = (0, import_react30.useMemo)(() => resolveWorkspacePath(), []);
    const hasWorkspace = Boolean(coreHttpUrl && workspacePath);
    const clearStatus = (0, import_react30.useCallback)(() => {
      setStatusMessage(null);
    }, []);
    const refreshInitiatives = (0, import_react30.useCallback)(
      async (preferredSlug) => {
    ...
    const selectedInitiative = (0, import_react30.useMemo)(
      () => initiatives.find(
    ...
    const handleInitiativeChange = (0, import_react30.useCallback)(
      (event) => {
    ...
    const createInitiative2 = (0, import_react30.useCallback)(
      async (input) => {
        if (!(coreHttpUrl && workspacePath)) {
  ...
  var ActionBar = ({ disabled = false }) => {
    ...
    const [createMode, setCreateMode] = (0, import_react31.useState)(null);
    const [draftName, setDraftName] = (0, import_react31.useState)("");
    const [draftDescription, setDraftDescription] = (0, import_react31.useState)("");
    const initiativePlaceholder = initiatives.length === 0 ? "No initiatives yet" : "Select initiative";
    const formTitle = "New initiative";
    const handleStartCreateInitiative = (0, import_react31.useCallback)(() => {
      clearStatus();
      setCreateMode("initiative");
      setDraftName("");
      setDraftDescription("");
    }, [clearStatus]);
    const handleCancelCreate = (0, import_react31.useCallback)(() => {
      setCreateMode(null);
      setDraftName("");
      setDraftDescription("");
    }, []);
    const handleSubmitCreate = (0, import_react31.useCallback)(
      async (event) => {
        event.preventDefault();
        if (!createMode) {
          return;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("header", { className: "action-bar", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "action-bar__surface", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "action-bar__context", children: /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "action-bar__context-group", children: [
        /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("label", { className: "action-bar__context-label", htmlFor: "initiative", children: "Initiative" }),
        /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "action-bar__context-row", children: [
          /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("option", { disabled: true, value: "", children: initiativePlaceholder }),
                initiatives.map((initiative) => /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
                  "option",
                  {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)("div", { className: "action-bar__buttons", children: [
        /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "action-bar__button-zone action-bar__button-zone--chat", children: CHAT_BUTTONS.map(({ id, label }) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(
            "button",
            {
              ...
              type: "button",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "action-bar__line", children: label[0] }),
                /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("span", { className: "action-bar__line", children: label[1] })
              ]
            },
            id
          );
        }) }),
        /* @__PURE__ */ (0, import_jsx_runtime39.jsx)("div", { className: "action-bar__button-zone action-bar__button-zone--flow", children: FLOW_BUTTONS.map(({ id, label }) => {
          const ariaLabel = label.filter(Boolean).join(" ");
          return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(
            "button",
            {
  ...
  var FullAppHost = () => {
    const [coreStatus, setCoreStatus] = (0, import_react32.useState)("connecting");
    const [coreStatusDetail, setCoreStatusDetail] = (0, import_react32.useState)();
    const [coreFinalized, setCoreFinalized] = (0, import_react32.useState)(false);
    const [messages, setMessages] = (0, import_react32.useState)(
      createDefaultMessages
    );
    const [activeMessageIndex, setActiveMessageIndex] = (0, import_react32.useState)(0);
    const {
      pickerState,
      providerLabels,
      selectedStage,
    ...
    const { settingsVisible, openSettings, closeSettings } = useSettingsVisibility();
    const shouldKickoffIdeaRef = (0, import_react32.useRef)(false);
    const {
    ...
    const confirmSelectionFromUi = (0, import_react32.useCallback)(
      (providerIds) => {
    ...
    const handleSessionCreatedMessage2 = (0, import_react32.useCallback)(
      (session) => {
        activateRoot();
        resetPicker();
    ...
    const handleShowSettings = (0, import_react32.useCallback)(() => {
      activateRoot();
      openSettings();
    }, [openSettings]);
    const handleCoreState = (0, import_react32.useCallback)(
      (payload) => {
        activateRoot();
    ...
    const handleSessionMessage = (0, import_react32.useCallback)(
      (payload) => {
        activateRoot();
    ...
    const handleSessionHistory = (0, import_react32.useCallback)(
      (payload) => {
        activateRoot();
    ...
    const handleSessionDeletedMessage2 = (0, import_react32.useCallback)(
      (payload) => {
        activateRoot();
    ...
    const handleSessionBindingMessage2 = (0, import_react32.useCallback)(
      (payload) => {
        activateRoot();
    ...
    (0, import_react32.useEffect)(() => {
      ...
      const timer = window.setInterval(() => {
        setActiveMessageIndex(
          (previous3) => (previous3 + 1) % MESSAGE_ORDER.length
        );
    ...
    const currentMessage = (0, import_react32.useMemo)(() => {
    ...
    const { headlineText, statusLine, detailLine } = (0, import_react32.useMemo)(() => {
      if (coreStatus === "error") {
        return {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)("div", { className: "app-shell", children: [
      /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(action_bar_default, { disabled: !isCoreReady }),
      ...
      isCoreReady ? null : /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("div", { className: "app-shell__status-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)("output", { "aria-live": "polite", className: "app-shell__status-card", children: [
        /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("span", { "aria-hidden": "true", className: "app-shell__status-indicator" }),
        /* @__PURE__ */ (0, import_jsx_runtime40.jsxs)("span", { className: "app-shell__status-text", children: [
          /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("span", { className: "app-shell__status-line", children: headlineText }),
          /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("span", { className: "app-shell__status-line", children: statusLine }),
          detailLine ? /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("span", { className: "app-shell__status-line app-shell__status-line--muted", children: detailLine }) : null
        ] })
      ] }) }),
      settingsVisible ? /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("div", { className: "settings-overlay", children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("div", { className: "settings-overlay__panel", children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(settings_view_default, { onClose: closeSettings }) }) }) : null
    ] });
  };
  var AppHost = () => SETTINGS_ONLY_MODE ? /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(SettingsOnlyHost, {}) : /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(FullAppHost, {});
  ...
  var mount = () => {
    ...
    root4.render(
      /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react33.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(app_host_default, {}) })
    );
  };
  mount();
})();
