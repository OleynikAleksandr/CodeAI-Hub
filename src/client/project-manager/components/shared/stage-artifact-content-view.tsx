...
const resolveArtifactStage = (
  artifactPath: string
): "virtual_simulation" | "diagram_modules" | "application_foundation_envelope" => {
  if (artifactPath.includes("/application_foundation_envelope/")) {
    return "application_foundation_envelope";
  }
