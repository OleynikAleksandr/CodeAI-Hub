    ...
    <div className="pm-details">
      ...
      <div style={{ display: "grid", gap: 10 }}>
        ...
        <div>
          ...
          <ul style={{ marginTop: 6 }}>
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.questionnaire_item_1",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.questionnaire_item_2",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.questionnaire_item_3",
                "who will use it;"
              )}
            </li>
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.questionnaire_item_4",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.questionnaire_item_5",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.questionnaire_item_6",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.questionnaire_item_7",
        ...
        <div>
          ...
          <ul style={{ marginTop: 6 }}>
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.why_it_helps_item_1",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.why_it_helps_item_2",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.why_it_helps_item_3",
            ...
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.why_it_helps_item_4",
        ...
        <div>
          {t(
            USER_MESSAGES_CATEGORY,
            "pm.description.help.glossary_intro",
            "Short glossary:"
          )}
          <ul style={{ marginTop: 6 }}>
            <li>
              ...
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.glossary.shell",
                "is the surface through which the user launches or opens the product."
              )}
            </li>
            <li>
              ...
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.glossary.product_part",
                "is a high-level part of the product that can live, run, or be delivered separately."
              )}
            </li>
            <li>
              <code>Cluster</code>{" "}
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.glossary.cluster",
                "is a large block made of several modules."
              )}
            </li>
            <li>
              <code>Module</code>{" "}
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.glossary.module",
                "is a separate working block with one clear role."
              )}
            </li>
            <li>
              <code>Boundary</code>{" "}
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.description.help.glossary.boundary",
                "is a border between system blocks."
              )}
            </li>
          </ul>
        </div>
