...
type IdeaCollectorProviderPickerProps = {
...
export const IdeaCollectorProviderPicker = ({
  visible,
  providers,
  onConfirm,
  onCancel,
}: IdeaCollectorProviderPickerProps) => {
  ...
  const statusMessage =
    providers.length === 0
      ...
      : selectedProvider
        ...
        : "Выберите провайдера для запуска Idea Collector.";
