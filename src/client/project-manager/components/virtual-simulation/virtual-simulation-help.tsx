        ...
        <div>
          ...
          <ul style={{ marginTop: 6 }}>
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.dialog_item_1",
                "who starts each important scenario;"
              )}
            </li>
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.dialog_item_2",
                "which parts of the product take part in it;"
              )}
            </li>
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.dialog_item_3",
                "what lives separately and where boundaries are already visible;"
              )}
            </li>
            <li>
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.dialog_item_4",
                "which system reaction counts as successful."
              )}
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul style={{ marginTop: 6 }}>
            <li>
              ...
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.glossary.shell",
                "is the product shell through which the user launches or opens the system."
              )}
            </li>
            <li>
              ...
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.glossary.product_part",
            ...
            <li>
              ...
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.glossary.cluster",
                "is a large block made of several modules with one external entry point through a facade."
              )}
            </li>
            <li>
              <code>Module</code>{" "}
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.glossary.module",
                "is a separate working block with one clear role and its own facade."
              )}
            </li>
            <li>
              <code>Boundary</code>{" "}
              {t(
                USER_MESSAGES_CATEGORY,
                "pm.virtual_simulation.help.glossary.boundary",
                "is a border between parts of the system."
              )}
            </li>
          </ul>
        </div>
