...
if [ -d "node_modules/@codeai-hub/claude-module" ] || [ -d "node_modules/@codeai-hub/codex-app-server-module" ] || [ -d "node_modules/@codeai-hub/glm-module" ] || [ -d "node_modules/@codeai-hub/glm-opencode-module" ] || [ -d "node_modules/@codeai-hub/kimi-module" ]; then
  echo "⚠️  Warning: Bundled provider modules detected, removing..."
  rm -rf node_modules/@codeai-hub/claude-module node_modules/@codeai-hub/codex-app-server-module node_modules/@codeai-hub/glm-module node_modules/@codeai-hub/glm-opencode-module node_modules/@codeai-hub/kimi-module
fi
