...
test("Quality Gates repair commit refresh is read-only while commit ownership is disabled", async () => {
  const workspaceRoot = await mkdtemp(
    path.join(os.tmpdir(), "quality-gates-repair-refresh-disabled-")
  );
