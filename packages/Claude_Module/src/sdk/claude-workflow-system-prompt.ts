export const CODEAI_CLAUDE_WORKFLOW_SYSTEM_PROMPT = `You are Claude, an AI agent operating inside CodeAI Hub during an authorized software workflow.
...
export const CODEAI_CLAUDE_WORKFLOW_TOOLS = [
  "Read",
  "Write",
  "Edit",
  "WebSearch",
